folder_Resource ='data/Lop4_Unit6';
var keyOldValue="";
var keyNewValue="";
var objectShowKey="";
...
//
var a_kqls13=["Yes","No","Yes","Yes","Yes"];
...
////
var lesson2=["Yes, he is","Thang Long","Nguyen Hue Street","Yes, it is","No, it isn't","playing hide-and-seek"];
...
var listen_22=["street","strong","stranger","scooter","score","Saigon Street","a small stranger","I love this school","His school is near Saigon School","Sunflower School is in Seven Street."];
var akq_22=["",""];
function ClickL22(){
	if(GetText("","")=="")
		SetText("","","x");
...
Page_1.add(title_1);
var title_0 = CreText('title_0',-1,2,126,66,"Unit 6",'#ffd700','#ffffff','#000000','#ffffff','',22,'Arial','Bold','center','middle',12,'0.00','0','1',0,'rgba(0, 0, 0, 0)','#ffd700','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
Page_1.add(title_0);
var Text_2 = CreText('Text_2',451,174,111,23,"TÊN TRƯỜNG",'#a4d1ff','#408080','#004080','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','12','0',1,'#005500','#a4d1ff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
Page_1.add(Text_2);
var Text_3 = CreText('Text_3',363,137,171,23,"Where is your school?",'rgba(0, 0, 0, 0)','#ff0000','#004080','#ffffff','',16,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ff0000','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(Text_3);
var Text_4 = CreText('Text_4',363,175,130,23,"Where is ",'rgba(0, 0, 0, 0)','#ff0000','#004080','#ffffff','',16,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ff0000','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(Text_4);
var Text_5 = CreText('Text_5',214,212,54,23,"It's in ",'rgba(0, 0, 0, 0)','#ffffff','#004080','#ffffff','',16,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(Text_5);
var Text_28 = CreText('Text_28',272,212,128,23,"TÊN TRƯỜNG",'#a4d1ff','#408080','#004080','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','12','0',1,'#005500','#a4d1ff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
Page_1.add(Text_28);
var Text_17 = CreText('Text_17',421,212,82,23,"Street.",'rgba(0, 0, 0, 0)','#ffffff','#004080','#ffffff','',16,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(Text_17);
var Text_18 = CreText('Text_18',175,251,467,24,"Where is your school? - It's in Nguyen Trai Street.",'rgba(0, 0, 0, 0)','#ffffff','#004080','#ffffff','',16,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(Text_18);
var Text_19 = CreText('Text_19',292,328,117,23,"TÊN LỚP",'#a4d1ff','#408080','#004080','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','12','0',1,'#005500','#a4d1ff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
Page_1.add(Text_19);
var Text_20 = CreText('Text_20',312,288,180,23,"What class are you in?",'rgba(0, 0, 0, 0)','#ffffff','#004080','#ffffff','',16,'Arial','Normal','center','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(Text_20);
var Text_22 = CreText('Text_22',231,328,95,23,"I'm in",'rgba(0, 0, 0, 0)','#ffffff','#004080','#ffffff','',16,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(Text_22);
var next = CreText('next',493,464,69,27,"›››",'#005500','#ffffff','#00ff00','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','0','0',2,'#00ff00','#005500','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(next);
var Text_1 = CreText('Text_1',130,365,331,23,"What class are you in? - I'm in 4A.",'rgba(0, 0, 0, 0)','#ffffff','#004080','#ffffff','',16,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_2.add(title_1);
var Image_1 = CreText('Image_1',90,97,443,115,'','rgba(0, 0, 0, 0)','','','','ID_IMAGE9.JPG',0,'','','','',0,'0.00','0','0',1,'rgba(0, 0, 0, 0)','','2','2','','0','0','4','0',0,0, '#808080');
Page_2.add(Image_1);
var flag_0 = CreText('flag_0',95,209,98,21,"street",'#ffffff','#ffffff','rgba(0, 0, 0, 0)','#ffffff','',16,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#282828','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
Page_2.add(flag_0);
var flag_1 = CreText('flag_1',206,209,92,21,"class",'#ffffff','#ffffff','rgba(0, 0, 0, 0)','#ffffff','',16,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#282828','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
Page_2.add(flag_1);
var flag_2 = CreText('flag_2',318,209,98,21,"school",'#ffffff','#ffffff','rgba(0, 0, 0, 0)','#ffffff','',16,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#282828','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
Page_2.add(flag_2);
...
Page_2.add(next);
var flag_3 = CreText('flag_3',429,209,101,21,"map",'#ffffff','#ffffff','rgba(0, 0, 0, 0)','#ffffff','',16,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#282828','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
Page_2.add(flag_3);
var ls1_1 = CreText('ls1_1',191,254,111,21,"street",'#ffffff','#ffffff','#000000','#ffffff','',14,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#000000','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',2,2,'#7f7f7f',0,1.50);
...
Page_2.add(ls1_1);
var ls1_0 = CreText('ls1_0',95,254,92,21,"school",'#ffffff','#ffffff','#000000','#ffffff','',14,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#000000','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',2,2,'#7f7f7f',0,1.50);
...
Page_2.add(ls1_0);
var ls1_2 = CreText('ls1_2',308,254,111,21,"map",'#ffffff','#ffffff','#000000','#ffffff','',14,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#000000','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',2,2,'#7f7f7f',0,1.50);
...
Page_2.add(ls1_2);
var ls1_3 = CreText('ls1_3',425,254,110,21,"class",'#ffffff','#ffffff','#000000','#ffffff','',14,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#000000','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',2,2,'#7f7f7f',0,1.50);
...
Page_2.add(ls1_3);
var mess = CreText('mess',182,89,202,106,"Complete",'rgba(255,255,0,0.78)','#ffffff','#000000','#ffffff','',20,'Arial','Normal','center','middle',0,'0.00','0','0',2,'#000000','rgba(255,255,128,0.78)','4','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
Page_2.add(mess);
var Text_5 = CreText('Text_5',182,89,203,19,"Message",'rgba(255,255,0,0.78)','#ffffff','#000000','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','1',1,'#000000','rgba(255,255,128,0.78)','4','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
Page_2.add(Text_5);
var btclose = CreText('btclose',241,169,84,19,"Close",'#ffff00','#ffffff','#000000','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',2,'#000000','#ffff80','4','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_3.add(title_1);
var title_2 = CreText('title_2',47,23,550,25,"Unscramble the words. Then rearrange the sentences to make three short dialogues.",'#ffffff','#ffffff','#004080','#ffffff','',14,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
title_2.on('mouseup touchend dragend',function(evt)/*---dragend---*/
{
m_pgObjCaller = this;
Speak(GetText("",""),"EN");
...
Page_3.add(b35_4);
var Text_1 = CreText('Text_1',47,46,551,20,"Xắp xếp lại từ. Sau đó, sắp xếp lại các câu để thực hiện ba cuộc đối thoại ngắn .",'#ffffff','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
Page_3.add(Text_1);
var L1_2 = CreText('L1_2',168,131,296,167,"Where is Rose Primary School please?\r\nIt's in Hill Street.\r\nLook at this map.\r\nOh, I see, Thanks you.\r\nWhere is Trang An school?\r\nIt's in Nguyen Du Street.",'#ffff80','#ccffcc','#000000','#ffffff','',12,'Arial','Normal','left','top',0,'0.00','0','0',1,'#000000','#ffffb9','4','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',20,1.80);
Page_3.add(L1_2);
...
Page_3.add(Text_12);
var Text_13 = CreText('Text_13',546,424,42,20,"›››",'#005500','#ffffff','#00ff00','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','0','0',2,'#00ff00','#005500','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
var cau13_4 = CreText('cau13_4',74,371,304,22,"5. Mai and Mary go to school together.",'rgba(0, 0, 0, 0)','#ffffff','#000000','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Trang_1.add(title_2);
var name_1 = CreText('name_1',136,69,416,189,"Where is your school?\r\nIt's in Le Loi Street.\r\nOh my school is also in Le Loi Street.\r\nWhat school is it?\r\nIt's Thang Loi Primary School. It's near the supermarket.\r\nOh, I see.\r\nWhy don't we go to school together?\r\nThat's a good idea. Let's go.",'rgba(0, 0, 0, 0)','#ffffff','#000000','#fffe99','',12,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,2.00);
Trang_1.add(name_1);
var name_0 = CreText('name_0',82,69,77,189,"Mai:\r\nMary:\r\nMai:\r\nMary:\r\nMai:\r\nMary:\r\nMai:\r\nMary:",'rgba(0, 0, 0, 0)','#ffffff','#0080ff','#ffffff','',12,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,2.00);
Trang_1.add(name_0);
...
Trang_1.add(title_1);
var cau13_2 = CreText('cau13_2',72,312,361,22,"3. Mai's school and Mary's school are in Le Loi Street.",'rgba(0, 0, 0, 0)','#ffffff','#000000','#fffe99','',12,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Trang_1.add(cau13_2);
var cau13_0 = CreText('cau13_0',72,252,304,22,"1. Mai's school is in Le Loi Street.",'rgba(0, 0, 0, 0)','#ffffff','#000000','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Trang_1.add(cau13_0);
var cau13_1 = CreText('cau13_1',72,282,304,22,"2. Mary's school isn't in Le Loi Street.",'rgba(0, 0, 0, 0)','#ffffff','#000000','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Trang_1.add(cau13_1);
var cau13_3 = CreText('cau13_3',72,342,304,22,"4. Mai's school is near supermarket.",'rgba(0, 0, 0, 0)','#ffffff','#000000','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Trang_1.add(cau13_3);
var m_diem = CreText('m_diem',467,263,113,94,"",'#8b0000','#ffffff','#ffff00','#ffffff','',48,'Arial','','center','middle',1,'0.00','0','0',1,'#00ff00','#ff0000','3','1','rgba(0, 0, 0, 0)','0','0','4','0',0,0, 'rgba(0, 0, 0, 0)',0,1.50);
Trang_1.add(m_diem);
...
Trang_1.add(Text_12);
var begin = CreText('begin',495,248,60,22,"check",'#804000','#ffffff','#ffffff','#ffffff','',12,'Arial','Bold','center','middle',0,'0.00','0','0',2,'#00ff00','#804000','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Trang_1.add(begin);
var lam_lai = CreText('lam_lai',492,351,60,22,"rework",'#804000','#ffffff','#ffffff','#ffffff','',12,'Arial','Bold','center','middle',0,'0.00','0','0',2,'#00ff00','#804000','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Trang_1.add(lam_lai);
var button13_0 = CreText('button13_0',390,252,42,22,"No",'#dfdfdf','#ffffff','#000000','#ffffff','',14,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#0000ff','#dfdfdf','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
var button13_4 = CreText('button13_4',390,371,42,22,"Yes",'#dfdfdf','#ffffff','#000000','#ffffff','',14,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#0000ff','#dfdfdf','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_4.add(Text_1);
var name_0 = CreText('name_0',66,68,307,184,"      Hi, my name is An. I'm Vietnamese. My school name is  Thang Long Primary School. It's in Nguyen Hue Street. It's an old but beautiful school. The school is very big. There are 50 classrooms. There are also lots of trees. We like playing hide-and-seek at out break time. ",'rgba(0, 0, 0, 0)','#000000','#000000','#ffffff','',12,'Arial','Normal','left','top',3,'0.00','3','0',1,'rgba(0, 0, 0, 0)','#ffffca','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',25,1.80);
...
Page_4.add(name_0);
var Text_9 = CreText('Text_9',69,403,367,24,"6. What do An and his friends do at break time?",'rgba(0, 0, 0, 0)','#ffffff','#000000','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
Page_4.add(Text_9);
var m_diem = CreText('m_diem',451,262,112,83,"",'#8b0000','#ffffff','#ffff00','#ffffff','',36,'Arial','','center','middle',1,'0.00','0','0',1,'#00ff00','#ff0000','3','1','rgba(0, 0, 0, 0)','0','0','4','0',0,0, 'rgba(0, 0, 0, 0)',0,1.50);
Page_4.add(m_diem);
var Text_4 = CreText('Text_4',70,85,170,24,"My School",'rgba(0, 0, 0, 0)','#ffffff','#000000','#ffffff','',14,'Arial','Bold','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
Page_4.add(Text_4);
...
Page_4.add(title_1);
var title_2 = CreText('title_2',63,59,392,24,"Read and answer with NO MORE THAN FOUR words.",'#ffffff','#ffffff','#000000','#ffffff','',12,'Arial','Normal','left','middle',3,'0.00','4','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
title_2.on('mouseup touchend dragend',function(evt)/*---dragend---*/
{
m_pgObjCaller = this;
Speak(GetText("",""),"EN");
...
Page_4.add(title_2);
var l21_0 = CreText('l21_0',337,261,110,24,"",'rgba(0, 0, 0, 0)','#ffffff','#0000ff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','1',1,'#000000','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_4.add(l21_0);
var Text_5 = CreText('Text_5',69,288,262,24,"2. What is his school's name?",'rgba(0, 0, 0, 0)','#ffffff','#000000','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
Page_4.add(Text_5);
var l21_1 = CreText('l21_1',337,288,110,24,"",'rgba(0, 0, 0, 0)','#ffffff','#0000ff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','1',1,'#000000','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_4.add(l21_1);
var l21_2 = CreText('l21_2',337,315,110,24,"",'rgba(0, 0, 0, 0)','#ffffff','#0000ff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','1',1,'#000000','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_4.add(l21_2);
var Text_10 = CreText('Text_10',69,260,262,24,"1. Is An Vietnamese?",'rgba(0, 0, 0, 0)','#ffffff','#000000','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
Page_4.add(Text_10);
var l21_3 = CreText('l21_3',337,342,110,24,"",'rgba(0, 0, 0, 0)','#ffffff','#0000ff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','1',1,'#000000','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_4.add(l21_3);
var Text_12 = CreText('Text_12',69,316,262,24,"3. What is his school?",'rgba(0, 0, 0, 0)','#ffffff','#000000','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
Page_4.add(Text_12);
var l21_4 = CreText('l21_4',337,369,110,24,"",'rgba(0, 0, 0, 0)','#ffffff','#0000ff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','1',1,'#000000','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_4.add(l21_4);
var Text_14 = CreText('Text_14',69,344,262,24,"4. Is his school old?",'rgba(0, 0, 0, 0)','#ffffff','#000000','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
Page_4.add(Text_14);
var l21_5 = CreText('l21_5',337,397,110,24,"",'rgba(0, 0, 0, 0)','#ffffff','#0000ff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','1',1,'#000000','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_4.add(Text_18);
var Text_6 = CreText('Text_6',69,372,262,24,"5. Is his school small?",'rgba(0, 0, 0, 0)','#ffffff','#000000','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
Page_4.add(Text_6);
...
{
m_pgObjCaller = this;
Speak("My school. "+ GetText("","name_0"),"EN");
  return;
}
 );
Page_4.add(Text_7);
var Image_1 = CreText('Image_1',378,97,160,143,'','rgba(0, 0, 0, 0)','','','','ID_IMAGE10.JPG',0,'','','','',0,'0.00','0','0',1,'rgba(0, 0, 0, 0)','','2','2','','0','0','4','0',0,0, '#808080');
Page_4.add(Image_1);
stage.add(Page_4);
...
var ls22_3 = CreText('ls22_3',94,142,361,21,"4.         scooter                                 streetlamp",'rgba(0, 0, 0, 0)','#ffffff','#000000','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_5.add(ls22_3);
var ls22_2 = CreText('ls22_2',94,112,279,21,"3.         scandal                                stranger",'rgba(0, 0, 0, 0)','#ffffff','#000000','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_5.add(title_2);
var ls22_0 = CreText('ls22_0',94,52,330,21,"1.         School                                  Street",'rgba(0, 0, 0, 0)','#ffffff','#000000','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
var ls22_1 = CreText('ls22_1',94,82,279,21,"2.         scan                                     strong",'rgba(0, 0, 0, 0)','#ffffff','#000000','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_5.add(ls22_1);
var ls22_4 = CreText('ls22_4',94,172,279,21,"5.         score                                    store",'rgba(0, 0, 0, 0)','#ffffff','#000000','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
var ls22_5 = CreText('ls22_5',94,222,351,21,"1.         Saigon School                             Saigon Street",'rgba(0, 0, 0, 0)','#ffffff','#000000','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_5.add(ls22_5);
var checkls22_10 = CreText('checkls22_10',117,224,14,14,"",'#ffffff','#ffffff','#000000','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#0000ff','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
var checkls22_11 = CreText('checkls22_11',264,223,14,14,"x",'#ffffff','#ffffff','#000000','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#0000ff','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
var ls22_6 = CreText('ls22_6',94,244,351,21,"2.         a small scooter.                        a small stranger.",'rgba(0, 0, 0, 0)','#ffffff','#000000','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
var ls22_7 = CreText('ls22_7',94,274,351,57,"3.         I love this school.\r\n            I love this street.\r\n            I love this skip.",'rgba(0, 0, 0, 0)','#ffffff','#000000','#ffffff','',12,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.80);
...
Page_5.add(ls22_7);
var checkls22_16 = CreText('checkls22_16',117,306,14,14,"",'#ffffff','#ffffff','#000000','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#0000ff','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
var checkls22_14 = CreText('checkls22_14',117,274,14,14,"x",'#ffffff','#ffffff','#000000','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#0000ff','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
var ls22_9 = CreText('ls22_9',94,392,351,56,"5.         Sunflower School is in Sutton Street.\r\n            Sunflower School is in Saigon Street.\r\n            Sunflower School is in Seven Street.",'rgba(0, 0, 0, 0)','#ffffff','#000000','#ffffff','',12,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.80);
...
Page_5.add(ls22_9);
var checkls22_22 = CreText('checkls22_22',117,422,14,14,"x",'#ffffff','#ffffff','#000000','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#0000ff','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_6.add(Text_4);
var Cau_hoi_0 = CreText('Cau_hoi_0',79,87,408,201,"Full name (1):\r\n\r\nNationality:(2)\r\n\r\nAge:(3)\r\n\r\nSchool(4):\r\n\r\nClass(5)\r\n\r\n",'#e8f3ff','#ffffff','#000000','#fffe99','',12,'Arial','Normal','left','top',0,'0.00','0','0',2,'#004080','#e8f3ff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',25,1.50);
...
Page_6.add(Text_17);
var Text_6 = CreText('Text_6',97,323,197,20,"1. What's the girl's name?",'rgba(0, 0, 0, 0)','#ffffff','#000000','#fffe99','',12,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_6.add(Text_6);
var Text_5 = CreText('Text_5',127,91,234,27,"A Friend from the USA",'rgba(0, 0, 0, 0)','#ffffff','#000000','#fffe99','',16,'Arial','Normal','center','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
Text_5.on('mouseup touchend dragend',function(evt)/*---dragend---*/
{
m_pgObjCaller = this;
Speak(GetText("",""),"EN");
...
Page_6.add(Text_5);
var Text_7 = CreText('Text_7',97,359,185,20,"2. Where's she from?",'rgba(0, 0, 0, 0)','#ffffff','#000000','#fffe99','',12,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
Text_7.on('mouseup touchend dragend',function(evt)/*---dragend---*/
{
m_pgObjCaller = this;
Speak(GetText("",""),"EN");
...
Page_6.add(Text_7);
var m_diem = CreText('m_diem',409,301,95,86,"",'#8b0000','#ffffff','#ffff00','#ffffff','',72,'Arial','','center','middle',1,'0.00','0','0',1,'#00ff00','#ff0000','3','1','rgba(0, 0, 0, 0)','0','0','4','0',0,0, 'rgba(0, 0, 0, 0)',0,1.50);
Page_6.add(m_diem);
var Check2 = CreText('Check2',425,288,62,23,"√ Check",'#804000','#ffffff','#ffffff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#00ff00','#804000','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
Check2.on('mouseup touchend dragend',function(evt)/*---dragend---*/
{
m_pgObjCaller = this;
CheckLesson31();
...
Page_6.add(Check2);
var m_repeat = CreText('m_repeat',423,375,67,23,"rework",'#804000','#ffffff','#ffffff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#00ff00','#804000','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
m_repeat.on('mouseup touchend dragend',function(evt)/*---dragend---*/
{
m_pgObjCaller = this;
InitLesson31();
...
Page_6.add(m_repeat);
var ls31_0 = CreText('ls31_0',205,123,169,24,"Mary Brown",'rgba(0, 0, 0, 0)','#ffffff','#0000ff','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','1',1,'#000000','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_6.add(ls31_0);
var ls31_1 = CreText('ls31_1',205,150,169,24,"American",'rgba(0, 0, 0, 0)','#ffffff','#0000ff','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','1',1,'#000000','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_6.add(ls31_1);
var ls31_2 = CreText('ls31_2',205,178,169,24,"Ten year old",'rgba(0, 0, 0, 0)','#ffffff','#0000ff','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','1',1,'#000000','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_6.add(ls31_2);
var ls31_3 = CreText('ls31_3',205,207,169,24,"Rose Primary School",'rgba(0, 0, 0, 0)','#ffffff','#0000ff','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','1',1,'#000000','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_6.add(ls31_3);
var Text_9 = CreText('Text_9',97,395,185,20,"3. Where's her school?",'rgba(0, 0, 0, 0)','#ffffff','#000000','#fffe99','',12,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
Text_9.on('mouseup touchend dragend',function(evt)/*---dragend---*/
{
m_pgObjCaller = this;
Speak(GetText("",""),"EN");
...
Page_6.add(Text_9);
var Text_10 = CreText('Text_10',98,435,250,20,"4. What class is she in?",'rgba(0, 0, 0, 0)','#ffffff','#000000','#fffe99','',12,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_6.add(Text_10);
var ls31_4 = CreText('ls31_4',205,238,169,24,"Her name's Mary Brown",'rgba(0, 0, 0, 0)','#ffffff','#0000ff','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','1',1,'#000000','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_6.add(ls31_4);
var ls31_5 = CreText('ls31_5',111,341,225,19,"Her name's Mary Brown",'rgba(0, 0, 0, 0)','#ffffff','#0000ff','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','1',1,'#000000','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_6.add(ls31_5);
var ls31_6 = CreText('ls31_6',112,377,225,19,"She's from America",'rgba(0, 0, 0, 0)','#ffffff','#0000ff','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','1',1,'#000000','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_6.add(ls31_6);
var ls31_7 = CreText('ls31_7',112,414,225,19,"It's Rose Primary School",'rgba(0, 0, 0, 0)','#ffffff','#0000ff','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','1',1,'#000000','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_6.add(ls31_7);
var Text_15 = CreText('Text_15',363,76,25,25,"Hello, everybody. My name's Mary Brown and I'm from America. I'm ten years old. My school name's Rose Primary School. It's near the supermarket, there are 3 floors and 40 classrooms. I'm in 4A. I like it.",'#ffffff','#ffffff','rgba(0, 0, 0, 0)','#ffffff','ID_IMAGE14.PNG',16,'Arial','Normal','center','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','2','2','rgba(0, 0, 0, 0)','0','0','4','0',0,0, 'rgba(0, 0, 0, 0)',0,1.50);
...
Page_6.add(Text_15);
var ls31_8 = CreText('ls31_8',111,454,225,24,"She's in class 4A",'rgba(0, 0, 0, 0)','#ffffff','#0000ff','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','1',1,'#000000','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_6.add(ls31_8);
var Image_1 = CreText('Image_1',400,94,82,55,'','rgba(0, 0, 0, 0)','','','','ID_IMAGE11.PNG',0,'','','','',0,'0.00','0','0',1,'rgba(0, 0, 0, 0)','','2','2','','0','0','4','0',0,0, '#808080');
Page_6.add(Image_1);
stage.add(Page_6);
...
Page_7.add(title_2);
var Image_1 = CreText('Image_1',76,43,207,183,'','rgba(0, 0, 0, 0)','','','','ID_IMAGE12.PNG',0,'','','','',0,'0.00','0','0',1,'rgba(0, 0, 0, 0)','','2','2','','0','0','4','0',0,0, '#808080');
Page_7.add(Image_1);
...
Page_7.add(Text_7);
var ls32_0 = CreText('ls32_0',105,250,292,24,"It's in Marble Street.",'rgba(0, 0, 0, 0)','#ffffff','#0000ff','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','1',1,'#000000','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_7.add(ls32_0);
var ls32_1 = CreText('ls32_1',105,279,292,24,"It's in Newton Street.",'rgba(0, 0, 0, 0)','#ffffff','#0000ff','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','1',1,'#000000','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_7.add(ls32_1);
var ls32_2 = CreText('ls32_2',105,308,292,24,"It's in Hill Street.",'rgba(0, 0, 0, 0)','#ffffff','#0000ff','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','1',1,'#000000','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
