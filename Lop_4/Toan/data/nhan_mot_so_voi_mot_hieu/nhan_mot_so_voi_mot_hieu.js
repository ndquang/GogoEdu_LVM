...
var Text_1 = CreText('Text_1',13,9,639,37,"Áp dụng tính chất nhân một số với một hiệu để tính:",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',26,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
