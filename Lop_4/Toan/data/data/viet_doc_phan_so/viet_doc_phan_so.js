...
var Text_1 = CreText('Text_1',427,144,56,57,"",'#ffffff','#ffffff','#000000','#ffffff','ID_IMAGE2.PNG',16,'Arial','Normal','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#000000','2','2','rgba(0,0,0,0)','0','0','4','0',0,0, 'rgba(0,0,0,0)',0,1.50);
...
Page_1.add(Page_1_Backrounnd,Text_1,Text_3,c1,c2,c3,c4,c5,c6,c7,c8,c9,title,in_0,check,score,in_1,c10,Text_2,msg);
stage.add(Page_1);
InitLacVietScript();
};
