...
function Submit()
{
	...
	if(GetText("","_kq")==_result  ){
		...
		SetText("","msg","Không chính xác: "+_result );
...
var _vp = CreText('_vp',476,185,114,41,"",'rgba(0,0,0,0)','#ffffff','#ffffff','#ffffff','',36,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#afeeee','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var btSubmit = CreText('btSubmit',605,188,128,32,"Submit",'#c0c0c0','#ffffff','#000000','#ffffff','',18,'Arial','Normal','center','middle',3,'0.00','5','0',2,'#ffffff','#ffffff','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var msg = CreText('msg',61,241,685,66,"good work",'rgba(0,0,0,0)','#ffffff','#80ff00','#ffffff','',24,'Arial','Bold Italic','center','middle',12,'0.00','4','4',0,'rgba(0,0,0,0)','#ffffff','0','0','#7f7f7f','0','0','4','1',3,3,'rgba(0,0,0,0)',0,1.50);
