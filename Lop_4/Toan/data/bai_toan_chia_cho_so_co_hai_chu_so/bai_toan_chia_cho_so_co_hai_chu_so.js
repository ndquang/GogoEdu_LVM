...
window.callBackLoadLesson = function callBackLoadLesson(SubmitContent)
{
	strFinshed = SubmitContent;
	SetText("","txtFinish",strFinshed);
	InvalidateObj("","");
}
...
var Text_1 = CreText('Text_1',0,0,598,64,"Bài toán: Chia cho số có hai chữ số",'#ffffe0','#ffffff','#000000','#ffffff','',26,'Arial','Bold','left','middle',0,'0.00','0','0',1,'#000000','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var in_0 = CreText('in_0',264,213,65,28,"",'rgba(0,0,0,0)','#ffffff','#282828','#ffffff','',20,'Arial','Normal','center','bottom',0,'0.00','0','0',1,'#0000ff','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var txtFinish = CreText('txtFinish',76,49,459,29,"",'#ffffe0','#c0c0c0','#000000','#ffffff','',18,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#000000','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var sound = CreText('sound',538,5,68,51,"",'#ffffff','#ffffff','#000000','#ffffff','ID_IMAGE1.PNG',16,'Arial','Normal','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#000000','2','2','rgba(0,0,0,0)','0','0','4','0',0,0, 'rgba(0,0,0,0)',0,1.50);
...
var check = CreText('check',244,262,128,50,"Submit",'#c0c0c0','#ffffff','#000000','#ffffff','',24,'Arial','Bold','center','middle',3,'0.00','5','0',1,'#7f7f7f','#ffffff','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var in_1 = CreText('in_1',411,212,69,28,"số dư",'rgba(0,0,0,0)','#ffffff','#282828','#ffffff','',20,'Arial','Normal','center','bottom',0,'0.00','0','0',1,'#0000ff','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var diem = CreText('diem',63,48,30,30,"",'#80ff80','#c0c0c0','#ff0000','#ffffff','',14,'Arial','Normal','center','middle',2,'0.00','0','0',1,'#000000','#80ff80','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
Page_1.add(Page_1_Backrounnd,_dv,Text_1,_cauhoi,in_0,txtFinish,msg,sound,Text_4,check,in_1,index,diem);
stage.add(Page_1);
InitLacVietScript();
};
