...
var Text_1 = CreText('Text_1',-171,503,629,33,"What is the measure of this angle? Choose the best estimate.\r\n",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',18,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var msg = CreText('msg',43,119,496,88,"good job",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',28,'Arial','Bold Italic','center','middle',11,'0.00','10','0',1,'#7f7f7f','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
Page_1.add(Page_1_Backrounnd,Text_3,Text_1,ch_0,ch_1,ch_2,ch_3,truc_y,btSubmit,truc_x,dot,score1,score2,score3,score4,score5,score6,score7,score8,score9,score10,msg);
stage.add(Page_1);
InitLacVietScript();
};
