...
function  CreateGame()
{
	...
	var so0 = Random(999)+1;
                var x = Random(3);
	if(x=1) so0 =so0 *10;
	else if(x=2) so0 =so0 *100;

	var so1 = Random(9)+1;
	x = Random(2);
	if(x=1) so1 =so1 *10;
	else if(x=0) so1 =so1 *100;
...
var Page_1_Backrounnd = CreText('Page_1_Backrounnd',0,0,550,300,'','#e6e6fa','','','','',12,'Times New Roman','','left','center',0,'0.00','0',0,'0',0,'#e6e6fa','0','0','0','','0','0','0','0',0,0,'');
var Text_3 = CreText('Text_3',200,152,123,31,"",'#ffffff','#ffffff','#000000','#ffffff','',28,'Arial','Normal','right','middle',0,'0.00','0','0',1,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var so0 = CreText('so0',209,83,115,32,"123456",'rgba(0,0,0,0)','#ffffff','#0000ff','#ffffff','',26,'Arial','Normal','right','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#e5e5e5','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var so1 = CreText('so1',212,117,113,32,"4",'rgba(0,0,0,0)','#ffffff','#0000ff','#ffffff','',26,'Arial','Normal','right','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#e5e5e5','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var so2 = CreText('so2',200,152,123,31,"123",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',26,'Arial','Normal','right','middle',0,'0.00','1','0',1,'#000000','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var title = CreText('title',10,35,206,27,"Phép nhân:",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',20,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var Text_1 = CreText('Text_1',-1,0,551,30,"Nhân với số có tận cùng là chữ số 0",'#ffff00','#ffffff','#000000','#ffffff','',20,'Arial','Bold','center','middle',0,'0.00','0','0',2,'#ffffff','#ffff00','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var check = CreText('check',349,208,110,36,"Kiểm tra",'#ffff62','#ffffff','#000000','#ffffff','',16,'Arial','Bold','center','middle',3,'0.00','5','0',1,'#0080ff','#ffd700','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var m_diem = CreText('m_diem',127,74,254,141,"Sai.",'rgba(255,255,0,1.02)','#ffffff','#000000','#ffffff','',20,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#7f7f7f','rgba(255,255,0,1.02)','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var bt_lam_lai = CreText('bt_lam_lai',208,178,96,30,"Tiếp",'#c0c0c0','#ffffff','#000000','#ffffff','',20,'Arial','Bold','center','middle',3,'0.00','5','0',1,'#000000','#e5e5e5','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
