folder_Resource ='/data/de_men_ben_vuc_ke_yeu';
var doan_van="";
var cau_van="";
var Startdot= 0;
var Enddot= 0;
...
var content = CreText('content',20,272,467,142,"      Một hôm, qua một vùng cỏ xước xanh dài, tôi chợt nghe tiếng khóc tỉ tê. Đi vào bước nữa, tôi gặp chị Nhà Trò ngồi gục đầu bên tảng đá cuội.\r\n      Chị Nhà Trò đã bé nhỏ lại gầy yếu quá, người bự những phấn, như mới lột. Chị mặc áo thâm dài, đôi chỗ chấm điểm vàng, hai cánh mỏng như cánh bướm non, lại ngắn chùn chùn. Hình như cánh yếu quá, chưa quen mở, mà cho dù có khỏe cũng chẳng bay được xa. Tôi đến gần, chị Nhà Trò vẫn khóc.",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var title = CreText('title',0,2,500,27,"Dế Mèn bênh vực kẻ yếu",'rgba(0,0,0,0)','#ffffff','#008040','#ffffff','',16,'Arial','Bold','center','middle',0,'0.00','0','1',2,'#008040','#000000','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
