folder_Resource ='/data/ai_da_nghi_ra_cac_chu_so';
var doan_van="";
var cau_van="";
var Startdot= 0;
var Enddot= 0;
...
var content = CreText('content',10,275,467,143,"  Người ta gọi các chữ số 1, 2, 3, 4,... là chữ số A-rập vì cho rằng chúng do người A-rập nghĩ ra. Sự thực thì không phải như vậy.\r\n       Vào năm 750, một nhà thiên văn học Ấn Độ đã đến thăm Bát-đa. Ông mang theo một bảng thiên văn do người Ấn Độ làm ra để dâng tặng quốc vương đang trị vì. Các chữ số Ấn Độ 1, 2, 3, 4,… dùng trong bảng đó đã được người A-rập nhanh chóng tiếp thu và về sau được truyền bá rộng rãi.",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.80);
var bt_nghe_viet = CreText('bt_nghe_viet',208,242,144,24,"Nghe viết chính tả",'#008040','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#ffffff','#008040','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var title = CreText('title',0,2,500,27,"          Ai đã nghĩ ra các chữ số  1, 2, 3, 4,… ?",'rgba(0,0,0,0)','#ffffff','#008040','#ffffff','',16,'Arial','Bold','center','middle',0,'0.00','0','1',2,'#008040','#000000','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var bt_NgheAll = CreText('bt_NgheAll',90,242,106,24,"Nghe cả bài",'#008040','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#ffffff','#008040','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var txt_input = CreText('txt_input',24,86,469,145,"",'#ffffff','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',1,'#008040','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.50);
...
var txtDiem = CreText('txtDiem',365,242,69,24,"Điểm",'#008040','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#ffffff','#008040','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
