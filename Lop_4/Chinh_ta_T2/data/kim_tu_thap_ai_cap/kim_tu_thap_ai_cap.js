folder_Resource ='/data/kim_tu_thap_ai_cap';
var doan_van="";
var cau_van="";
var Startdot= 0;
var Enddot= 0;
...
var content = CreText('content',20,273,467,171,"      Kim tự tháp Ai Cập là lăng mộ của các hoàng đế Ai Cập cổ đại. Đó là những công trình kiến trúc xây dựng toàn bằng đá tảng. Từ cửa kim tự tháp đi vào là một hành lang tối và hẹp, đường càng đi càng nhằng nhịt dẫn tới những giếng sâu, phòng chứa quan tài, buồng để đồ,… Thăm kim tự tháp, người ta không khỏi ngạc nhiên: Người Ai Cập cổ không có những phương tiện chuyên chở vật liệu như hiện nay, làm thế nào mà họ đã vận chuyển được những tảng đá to như vậy lên cao?",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.80);
...
var title = CreText('title',0,2,500,27,"Kim tự tháp Ai Cập",'rgba(0,0,0,0)','#ffffff','#008040','#ffffff','',16,'Arial','Bold','center','middle',0,'0.00','0','1',2,'#008040','#000000','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
