folder_Resource ='data/u3_What_day_is_it_today';
var index=0;
var len=0;
var dem=0;
var diem = 0;
...
var w = CreText('w',178,145,447,67,"Hello",'rgba(255,255,255,0.44)','#ffffff','#000000','#000000','',36,'Arial','Normal','center','middle',11,'0.00','10','0',1,'#ffffff','rgba(255,255,255,0.44)','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var v = CreText('v',178,263,447,77,"1000",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',28,'Arial','Normal','center','middle',3,'0.00','10','0',0,'rgba(0,0,0,0)','rgba(255,255,255,0.44)','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var help = CreText('help',717,128,67,67,"help",'rgba(255,255,255,0.44)','#ffffff','#000000','#000000','',24,'Arial','Normal','center','middle',2,'0.00','0','0',1,'#ffffff','rgba(255,255,255,0.44)','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var tao = CreText('tao',717,57,67,67,"new",'rgba(255,255,255,0.44)','#ffffff','#000000','#000000','',24,'Arial','Normal','center','middle',2,'0.00','0','0',1,'#ffffff','rgba(255,255,255,0.44)','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var Text_1 = CreText('Text_1',717,201,67,67,"↓",'rgba(255,255,255,0.44)','#ffffff','#000000','#000000','',26,'Arial','Bold','center','middle',2,'0.00','0','0',1,'#ffffff','rgba(255,255,255,0.44)','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var title = CreText('title',3,1,797,51,"What day is it today?",'rgba(0,128,192,0.67)','#ffffff','#ffffff','#ffffff','',28,'Arial','Bold','center','middle',0,'0.00','0','1',1,'#ffffff','rgba(0,128,192,0.67)','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var unit = CreText('unit',1,1,134,51,"Unit 3",'rgba(0,128,255,0.89)','#ffffff','#ffffff','#ffffff','',26,'Arial','Normal','center','middle',12,'0.00','0','1',1,'#ffffff','rgba(0,128,255,0.89)','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var hits = CreText('hits',178,214,447,47,"",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',26,'Arial','Normal','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','rgba(192,192,192,0.44)','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
