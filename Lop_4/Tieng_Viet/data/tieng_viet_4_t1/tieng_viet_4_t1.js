folder_Resource ='data/tieng_viet_4_t1';
...
var Page_1_Backrounnd = CreText('Page_1_Backrounnd',0,0,740,500,'','#ffffff','','','','',12,'Times New Roman','','left','center',0,'0.00','0',0,'0',0,'#ffffff','0','0','0','','0','0','0','0',0,0,'');
...
var header = CreText('header',62,10,654,76,"Title",'rgba(0,0,0,0)','#ffffff','#0080c0','#ffffff','',28,'Arial','Bold','center','middle',12,'0.00','0','2',6,'#756fb3','#009300','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var unit = CreText('unit',26,7,79,81,"Bài",'#756fb3','#ff6820','#ffffff','#ffffff','',16,'Arial Unicode MS','Bold','center','top',2,'0.00','0','3',4,'#dddddd','#756fb3','0','1','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',3,1.50);
...
var section0 = CreText('section0',4,103,122,35,"I. ĐỌC",'rgba(0,0,0,0)','#ffe4e1','#0080c0','#ffffff','',14,'Arial','Bold','left','middle',12,'0.00','0','1',2,'#0080c0','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var section1 = CreText('section1',4,152,122,35,"II. NGHE VÀ VIẾT",'rgba(0,0,0,0)','#ffe4e1','#0080c0','#ffffff','',14,'Arial','Bold','left','middle',12,'0.00','0','1',2,'#0080c0','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
Page_1.add(Page_1_Backrounnd,msg,answer,bt_Check,header,unit,bai,bt_Next,cau,bt_Prev,section0,id,section1,score,btnPlay,title,question,Text_1);
stage.add(Page_1);
InitLacVietScript();
};
