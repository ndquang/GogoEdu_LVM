folder_Resource ='data/tro_choi_ghep_hinh';
var rx = 3;
var cx = 3;
var supID ="";
var diem=0;
...
function  CheckSucess(){
	...
	PlaySound("S_OK");
	iStart  = 1 ;
	var sumdiem = diem + rx *cx;
	SetText("","msg",sumdiem + " Điểm");
...
{
var left = GetLeft("",objD) ;
var top = GetTop("",objD);
transitionTo("",objS,100,left ,top,'{"x":1,"y":1}',0,1,16,"SwapData('"+objS+"','"+objD+"')");
...
function RandomNESW( name)
{	
		var rename = null;///sua thanh null
		var nextObj = "";
		var r =  leftStr(name,1);
		var c  =  rightStr(name,1);
		if(GetText("",name)=="")
		{
		    while (rename == null)//sua thanh null
			{
				var rr = Random(4);
				var nextCol = 0;
				var nextRow= 0;
...
function  SwapData( objS,  objD)
{
		...
		if(dText =="")		
		SetColorEx("",objS,"rgba(255,0,0,0.0)");
		else
		SetColorEx("", objS, "#",supID +dText );

		MoveObjectTo("",objS,-1,-1);		
		iStart++;
		if(iStart<=rx*cx*3)
		  RandomImage();
		if(iStart==rx*cx*3)
...
iStart=0;
SetText("","_0_1","");
SetColorEx("","_0_1","rgba(255,0,0,0.0)");
...
var Page_1_Backrounnd = CreText('Page_1_Backrounnd',0,0,600,480,'','#ffffff','','','','ID_IMAGE1.JPG',12,'Times New Roman','','left','center',0,'0.00','0',0,'0',0,'#000000','2','2','0','','0','0','0','0',0,0,'');
...
var _2_2 = CreText('2_2',330,245,98,80,"7",'#ffffff','#ffffff','rgba(0,0,0,0)','#ffffff','',16,'Verdana','Normal','center','middle',3,'0.00','5','0',2,'#c0c0c0','#ffffff','2','2','rgba(0,0,0,0)','0','0','4','1',0,0, '#ffffff',0,1.50);
...
var Text_2 = CreText('Text_2',333,80,197,79,"Game ghép hình",'#009300','#ffffff','#ffffff','#ffffff','',20,'Arial','Bold','center','middle',3,'0.00','5','0',4,'#32cd32','#009300','0','0','#ffff00','0','0','4','1',0,0,'rgba(0,0,0,0)',0,1.50);
...
var Text_3 = CreText('Text_3',95,395,31,31,"››",'#00a400','#ffffff','#ffffff','#000000','',24,'Arial','Bold','center','middle',2,'0.00','0','0',2,'#ffff00','#00a400','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var bgmsg = CreText('bgmsg',278,213,202,94,"",'#ffffff','#ffffff','#ffffff','#ffffff','ID_IMAGE10.PNG',18,'Arial','Bold','right','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#000000','2','2','#ffff00','0','0','4','1',0,0, 'rgba(0,0,0,0)',0,1.50);
bgmsg.on('mouseup touchend dragend',function(evt)/*---dragend---*/
{
m_pgObjCaller = this;
TronAnh();
  return;
...
var msg = CreText('msg',283,217,75,77,"Hoàn thành",'#ffffff','#ffffff','#0000ff','#ffffff','',20,'Arial','Bold','center','middle',2,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var sucess = new Kinetic.Group({name:'sucess',x:0,y:0,width:206,height:98});
sucess.add(bgmsg,msg);
Page_1.add(Page_1_Backrounnd,Text_1,_0_1,_1_2,_1_1,_3_2,_2_3,_2_2,_2_1,img_0,img_1,img_2,img_3,img_4,img_5,_1_3,_3_1,_3_3,preview,img_6,img_7,Text_2,bt_showhide,Text_3,sucess);
stage.add(Page_1);

 var Page_2 = new Kinetic.Layer({name: 'Page_2',callback:'Page_2()'});
var Page_2_Backrounnd = CreText('Page_2_Backrounnd',0,0,600,480,'','#ffffff','','','','ID_IMAGE1.JPG',12,'Times New Roman','','left','center',0,'0.00','0',0,'0',0,'#000000','2','2','0','','0','0','0','0',0,0,'');
...
var Text_2 = CreText('Text_2',96,396,31,31,"«",'#00a400','#ffffff','#ffffff','#000000','',24,'Arial','Bold','center','middle',2,'0.00','0','0',2,'#ffff00','#00a400','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var bgmsg = CreText('bgmsg',268,198,202,94,"",'#ffffff','#ffffff','#ffffff','#ffffff','ID_IMAGE10.PNG',18,'Arial','Bold','right','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#000000','2','2','#ffff00','0','0','4','1',0,0, 'rgba(0,0,0,0)',0,1.50);
bgmsg.on('mouseup touchend dragend',function(evt)/*---dragend---*/
{
m_pgObjCaller = this;
TronAnh();
...
var msg = CreText('msg',273,202,75,77,"Hoàn thành",'#ffffff','#ffffff','#0000ff','#ffffff','',20,'Arial','Bold','center','middle',2,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
msg.on('mouseup touchend dragend',function(evt)/*---dragend---*/
{
m_pgObjCaller = this;
TronAnh();
...
var sucess = new Kinetic.Group({name:'sucess',x:0,y:0,width:206,height:98});
sucess.add(bgmsg,msg);
Page_2.add(Page_2_Backrounnd,Text_1,_1_1,_1_2,_1_3,_2_1,_2_2,_2_3,_3_1,_3_2,_3_3,_0_1,preview,_4_1,_4_2,_4_3,_5_1,_5_2,_5_3,_1_4,_2_4,_3_4,_4_4,_5_4,Text_2,btNext,_6_1,_6_2,_6_3,_6_4,Text_3,bt_showhide,sucess);
stage.add(Page_2);
InitLacVietScript();
};
