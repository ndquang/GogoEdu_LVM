folder_Resource ='data/Writing_9';
...
function getChatMessages() {
   ...
   SaveLesson(cauDich);
    return [
        {role: "system",content: "Bạn là giáo viên tiếng Anh lớp 8. Hãy chấm điểm cho phần viết của học sinh lớp 8. Yêu cầu: Chấm theo thang điểm 10. Góp ý nếu có lỗi sai ngữ pháp, từ vựng, hoặc cấu trúc câu. Giải thích bằng tiếng việt"}, {role: "user",content: `Đề bài: ${cauGoc}\nHọc sinh viết (Tiếng Anh): ${cauDich}`
        }
    ];
...
var strVietNamese = CreText('strVietNamese',28,2,687,40,"Write 4–5 sentences about Tet holiday in Vietnam.",'rgba(0,0,0,0)','#ffffff','#009300','#ffffff','',18,'Segoe UI','Bold','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var strEnglish = CreText('strEnglish',34,49,682,188,"",'#ffffff','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',1,'#32cd32','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.70);
var bt_Check = CreText('bt_Check',585,247,132,44,"Nộp bài",'#defede','#ffffff','#000000','#ffffff','',16,'Arial','Bold','center','middle',3,'0.00','10','0',1,'#009300','#defede','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var chat_output = CreText('chat_output',34,298,682,329,"",'#ffffff','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',1,'#32cd32','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.70);
...
Page_1.add(strVietNamese,strEnglish,bt_Check,chat_output,Text_2);
stage.add(Page_1);
InitLacVietScript();
};
