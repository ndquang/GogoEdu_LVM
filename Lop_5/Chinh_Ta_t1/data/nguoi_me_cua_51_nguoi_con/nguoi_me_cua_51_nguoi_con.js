folder_Resource ='/data/nguoi_me_cua_51_nguoi_con';
var doan_van="";
var cau_van="";
var Startdot= 0;
var Enddot= 0;
...
var content = CreText('content',16,307,467,158,"        Ở huyện đảo Lý Sơn, tỉnh Quảng Ngãi có một phụ nữ không sinh con nhưng lại được 51 người gọi bằng mẹ. Suốt 35 năm qua, bà thức khuya dậy sớm, bươn chải, quên cả hạnh phúc riêng để cưu mang, nuôi dưỡng 51 đứa trẻ mồ côi. Đến nay, 48 người con đã trưởng thành nhờ tình yêu thương của mẹ. Người phụ nữ có tấm lòng nhân ái đó là mẹ Nguyễn Thị Phú ở đội 10, thôn Đông, xã Lý Hải. Nay đã ở tuổi 62, mẹ vẫn bận rộn với 3 đứa trẻ chưa tròn 1 tuổi.",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.80);
var bt_nghe_viet = CreText('bt_nghe_viet',201,272,144,24,"Nghe viết chính tả",'#004080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#666666','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var title = CreText('title',-2,-2,502,27,"Người mẹ của 51 đứa con",'rgba(0,0,0,0)','#ffffff','#004080','#004080','',14,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#004080','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.50);
var bt_NgheAll = CreText('bt_NgheAll',83,272,106,24,"Nghe cả bài",'#004080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#666666','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var txt_input = CreText('txt_input',24,86,460,179,"",'#ffffff','#ffffff','#000000','#ff6820','',14,'Arial','Normal','left','top',0,'0.00','0','0',1,'#004080','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.50);
...
var txtDiem = CreText('txtDiem',358,272,69,24,"Điểm",'#004080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#666666','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
