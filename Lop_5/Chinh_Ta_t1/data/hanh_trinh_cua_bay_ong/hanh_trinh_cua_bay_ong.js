folder_Resource ='/data/hanh_trinh_cua_bay_ong';
var doan_van="";
var cau_van="";
var Startdot= 0;
var Enddot= 0;
...
var Page_1_Backrounnd = CreText('Page_1_Backrounnd',0,0,500,680,'','#ffffff','','','','',12,'Times New Roman','','left','center',0,'0.00','0',0,'0',0,'#ffffff','0','0','0','','0','0','0','0',0,0,'');
var content = CreText('content',8,405,467,275,"Bầy ong rong ruổi trăm miền\r\nRù rì đôi cánh nối liền mùa hoa.\r\nNối rừng hoang với biển xa\r\nĐất nơi đâu cũng tìm ra ngọt ngào.\r\n(Nếu hoa có ở trời cao\r\nThì bầy ong cũng mang vào mật thơm)\r\n\r\nChắt trong vị ngọt mùi hương\r\nLặng thầm thay những con đường ong bay.\r\nTrải qua mưa nắng vơi đầy\r\nMen trời đất đủ làm say đất trời.\r\nBầy ong giữ hộ cho người\r\nNhững mùa hoa đã tàn phai tháng ngày.",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',14,'Arial','Normal','center','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.80);
var bt_nghe_viet = CreText('bt_nghe_viet',208,373,144,24,"Nghe viết chính tả",'#004080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#666666','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var title = CreText('title',-2,-2,502,27,"Hành trình của bầy ong ",'rgba(0,0,0,0)','#ffffff','#004080','#004080','',14,'Arial','Normal','center','top',0,'0.00','0','0',1,'#004080','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.50);
var bt_NgheAll = CreText('bt_NgheAll',90,373,106,24,"Nghe cả bài",'#004080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#666666','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var txt_input = CreText('txt_input',24,86,462,272,"",'#ffffff','#ffffff','#000000','#ff6820','',14,'Arial','Normal','left','top',0,'0.00','0','0',1,'#004080','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.50);
...
var txtDiem = CreText('txtDiem',365,373,69,24,"Điểm",'#004080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#666666','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var wrong_word = CreText('wrong_word',97,171,306,133,"",'#f3f3f3','#ffffff','#004080','#004080','',10,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#004080','#f3f3f3','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var ww_title = CreText('ww_title',97,153,306,22,"Bạn sai các từ sau:",'#004080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#666666','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var btClose = CreText('btClose',375,154,27,20,"X",'#ffffff','#ffffff','#ff0000','#ffffff','',12,'Arial','Bold','center','middle',3,'0.00','5','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var m_diem = CreText('m_diem',314,243,87,61,"",'rgba(0,0,0,0)','#ffffff','#ff0000','#ffffff','',48,'Arial','Normal','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
