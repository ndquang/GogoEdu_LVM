folder_Resource ='/data/ve_ngoi_nha_dang_xay';
var doan_van="";
var cau_van="";
var Startdot= 0;
var Enddot= 0;
...
var Page_1_Backrounnd = CreText('Page_1_Backrounnd',0,0,500,550,'','#ffffff','','','','',12,'Times New Roman','','left','center',0,'0.00','0',0,'0',0,'#ffffff','0','0','0','','0','0','0','0',0,0,'');
var content = CreText('content',14,345,467,205,"Chiều đi học về\r\nChúng em qua ngôi nhà xây dở\r\nGiàn giáo tựa cái lồng che chở\r\nTrụ bê tông nhú lên như một mầm cây\r\nBác thợ nề ra về còn huơ huơ cái bay:\r\nTạm biệt!\r\n\r\nNgôi nhà tựa vào nền trời sẫm biếc\r\nThở ra mùi vôi vữa nồng hăng\r\nNgôi nhà giống bài thơ sắp làm xong\r\nLà bức tranh còn nguyên màu vôi, gạch.",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.80);
var bt_nghe_viet = CreText('bt_nghe_viet',204,304,144,24,"Nghe viết chính tả",'#004080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#666666','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var title = CreText('title',-2,-2,502,27,"Về ngôi nhà đang xây",'rgba(0,0,0,0)','#ffffff','#004080','#004080','',14,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#004080','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.50);
var bt_NgheAll = CreText('bt_NgheAll',86,304,106,24,"Nghe cả bài",'#004080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#666666','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var txt_input = CreText('txt_input',24,86,465,208,"",'#ffffff','#ffffff','#000000','#ff6820','',14,'Arial','Normal','left','top',0,'0.00','0','0',1,'#004080','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.50);
...
var txtDiem = CreText('txtDiem',361,304,69,24,"Điểm",'#004080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#666666','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
