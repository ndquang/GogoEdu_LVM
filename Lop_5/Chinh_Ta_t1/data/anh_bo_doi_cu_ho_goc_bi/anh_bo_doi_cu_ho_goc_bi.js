folder_Resource ='/data/anh_bo_doi_cu_ho_goc_bi';
var doan_van="";
var cau_van="";
var Startdot= 0;
var Enddot= 0;
...
var content = CreText('content',20,273,467,171,"      Phrăng Đơ Bô-en là một người lính Bỉ trong quân đội Pháp xâm lược Việt Nam. Nhận rõ tính chất phi nghĩa của cuộc chiến tranh xâm lược, năm 1949, ông chạy sang hàng ngũ quân đội ta, lấy tên Việt là Phan Lăng. Một lần, rơi vào ổ phục kích, ông bị địch bắt. Địch dụ dỗ, tra tấn thế nào cũng không khuất phục được ông, bèn đưa ông về giam ở Pháp.\r\n     Năm 1986, Phan Lăng cùng con trai đi thăm Việt Nam, về lại nơi ông đã từng chiến đấu vì chính nghĩa.",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.80);
...
var title = CreText('title',-2,-2,502,27,"Anh bộ đôi Cụ Hồ gốc Bỉ",'rgba(0,0,0,0)','#ffffff','#004080','#004080','',14,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#004080','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.50);
