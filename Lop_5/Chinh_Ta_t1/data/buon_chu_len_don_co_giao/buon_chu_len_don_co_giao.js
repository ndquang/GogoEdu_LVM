folder_Resource ='/data/buon_chu_len_don_co_giao';
var doan_van="";
var cau_van="";
var Startdot= 0;
var Enddot= 0;
...
var content = CreText('content',20,273,467,171,"      Y Hoa lấy trong gùi ra một trang giấy, trải lên sàn nhà. Mọi người im phăng phắc. Y Hoa nghe rõ cả tiếng đập trong lồng ngực mình. Quỳ hai gối lên sàn, cô viết hai chữ thật to, thật đậm: ‟Bác Hồ”. Y Hoa viết xong, bỗng bao nhiêu tiếng cùng hò reo:\r\n- Ôi, chữ cô giáo này! Nhìn kìa!\r\n- A, chữ, chữ cô giáo!.",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.80);
...
var title = CreText('title',-2,-2,502,27,"Buôn Chư Lênh đón cô giáo",'rgba(0,0,0,0)','#ffffff','#004080','#004080','',14,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#004080','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.50);
