folder_Resource ='data/cong_so_do_thoi_gian';
var cntQst = 10;
var _score = 0;
var _cSubmit = 0;
var _index = 1;
...
var Text_1 = CreText('Text_1',0,0,750,59,"Cộng số đo thời gian",'#008080','#ffffff','#ffffff','#ffffff','',26,'Arial','Bold','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#008080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var check = CreText('check',248,236,175,50,"Submit",'#008080','#ffffff','#ffffff','#ffffff','',24,'Arial','Bold','center','middle',11,'0.00','10','0',1,'#ffffff','#008080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var msg = CreText('msg',166,161,373,135,"",'#e6e6fa','#ccffff','#282828','#ffffff','',20,'Arial','Normal','center','top',11,'0.00','10','0',1,'#0080ff','#e6e6fa','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var next = CreText('next',285,242,138,48,"Câu tiếp",'#008080','#0080ff','#ffffff','#ffffff','',24,'Arial','Bold','center','middle',11,'0.00','10','0',1,'#ffffff','#008080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var Text_4 = CreText('Text_4',185,127,336,32,"https://gogoedu.vn",'#008080','#ffffff','#ffffff','#ffffff','',16,'Arial','Normal','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#008080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var gr_msg = new Kinetic.Group({name:'gr_msg',x:0,y:0,width:377,height:167});
gr_msg.add(msg,Text_4,next);
var _score = CreText('_score',660,4,86,52,"0",'#ffffff','#ffffff','#008080','#ffffff','',36,'Arial','Bold','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
