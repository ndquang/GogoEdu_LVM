folder_Resource ='data/van_toc_toan_lop5';
var cntQst = 10;
var _score = 0;
var _cSubmit = 0;
var _index = 1;
...
var dv_0 = CreText('dv_0',450,235,199,37,"%",'rgba(0,0,0,0)','#ffffff','#000000','#000000','',20,'Arial','Normal','left','middle',0,'0.00','0','0',0,'#000000','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var Text_1 = CreText('Text_1',0,0,689,49,"Vận tốc",'#ffa448','#ffffff','#000000','#ffffff','',26,'Arial','Bold','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffa448','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var in_0 = CreText('in_0',343,235,85,37,"",'rgba(213,234,255,0.22)','#ffffff','#282828','#000000','',20,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#000000','rgba(213,234,255,0.22)','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var lg_0 = CreText('lg_0',32,180,716,41,"",'rgba(0,0,0,0)','#ffffff','#000000','#000000','',20,'Arial','Normal','left','middle',0,'0.00','0','0',0,'#000000','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var tt_0 = CreText('tt_0',103,235,183,37,"",'rgba(213,234,255,0.22)','#ffffff','#282828','#000000','',20,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#000000','rgba(213,234,255,0.22)','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var Text_5 = CreText('Text_5',306,235,47,37,"=",'rgba(0,0,0,0)','#ffffff','#000000','#000000','',20,'Arial','Normal','left','middle',0,'0.00','0','0',0,'#000000','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var check = CreText('check',230,320,175,50,"Nộp bài",'#ffa448','#ffffff','#000000','#ffffff','',20,'Arial','Bold','center','middle',11,'0.00','10','0',1,'#000000','#ffa448','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var _cauhoi = CreText('_cauhoi',19,88,726,60,"",'rgba(0,0,0,0)','#ffffff','#000000','#000000','',18,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#e6e6fa','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var msg = CreText('msg',175,328,373,135,"",'#e6e6fa','#ccffff','#282828','#ffffff','',20,'Arial','Normal','center','top',11,'0.00','10','0',1,'#000000','#e6e6fa','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var next = CreText('next',294,422,138,35,"Câu tiếp",'#ffa448','#0080ff','#000000','#ffffff','',16,'Arial','Bold','center','middle',11,'0.00','10','0',1,'#000000','#ffa448','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var title = CreText('title',193,299,336,30,"https://gogoedu.vn",'#ffa448','#ffffff','#000000','#ffffff','',16,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#000000','#ffa448','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var gr_msg = new Kinetic.Group({name:'gr_msg',x:0,y:0,width:377,height:168});
gr_msg.add(msg,next,title);
