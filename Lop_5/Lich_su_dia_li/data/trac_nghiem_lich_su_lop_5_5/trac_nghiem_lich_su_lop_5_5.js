folder_Resource = '/data/trac_nghiem_lich_su_lop_5_5';
var cntQst = 20;
var _score = 0;
var _cSubmit = 0;
var _index = 1;
...
window.onload = function () {
	...
	var title = CreText('title', 43, 9, 749, 49, "Phan Bội Châu và phong trào Đông du", 'rgba(0,0,0,0)', '#ffffff', '#0080ff', '#ffffff', '', 26, 'Arial', 'Bold', 'center', 'middle', 0, '0.00', '0', '0', 0, 'rgba(0,0,0,0)', '#008000', '0', '0', 'rgba(0,0,0,0)', '0', '0', '4', '0', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	...
	var _1 = CreText('_1', 85, 257, 624, 50, "Nhóm thanh niên Việt Nam ở Nhật Bản hăng say học tập để làm gì?|Mau chóng học|Học xong về nước|Trở về cứu nước|Học giỏi|2", 'rgba(0,0,0,0)', '#ffffff', '#004080', '#ffffff', '', 18, 'Arial', 'Normal', 'left', 'middle', 3, '0.00', '5', '0', 1, '#0080ff', '#ffffff', '0', '0', 'rgba(0,0,0,0)', '0', '0', '4', '0', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	...
	var _2 = CreText('_2', 85, 316, 624, 50, "Thực dân Pháp cấu kết với Nhật chống phá phong trào Đông du vào|Năm 1904|Năm 1905|Năm 1908|Năm 1909|2", 'rgba(0,0,0,0)', '#ffffff', '#004080', '#ffffff', '', 18, 'Arial', 'Normal', 'left', 'middle', 3, '0.00', '5', '0', 1, '#0080ff', '#ffffff', '0', '0', 'rgba(0,0,0,0)', '0', '0', '4', '0', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	...
	var _3 = CreText('_3', 85, 376, 624, 50, "Mục đích của phong trào Đồng du là gì?|Đưa thanh niên Việt Nam sang Nhật học|Đào tạo nhân tài|Giải phóng dân tộc|Đào tạo nhân tài cứu nước|3", 'rgba(0,0,0,0)', '#ffffff', '#004080', '#ffffff', '', 18, 'Arial', 'Normal', 'left', 'middle', 3, '0.00', '5', '0', 1, '#0080ff', '#ffffff', '0', '0', 'rgba(0,0,0,0)', '0', '0', '4', '0', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	...
	var Text_1 = CreText('Text_1', -13, 15, 146, 34, "Bài 5", 'rgba(0,0,0,0)', '#ffffff', 'rgba(0,0,0,0)', '#ffffff', '', 24, 'Arial', 'Bold', 'center', 'middle', 0, '0.00', '0', '0', 0, 'rgba(0,0,0,0)', '#dff9f9', '0', '0', '#0080c0', '0', '0', '4', '1', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
