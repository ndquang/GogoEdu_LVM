folder_Resource = '/data/trac_nghiem_lich_su_lop_5_8';
var cntQst = 20;
var _score = 0;
var _cSubmit = 0;
var _index = 1;
...
window.onload = function () {
	...
	var title = CreText('title', 106, 9, 637, 49, "Xô viết Nghệ Tĩnh", 'rgba(0,0,0,0)', '#ffffff', '#0080ff', '#ffffff', '', 26, 'Arial', 'Bold', 'center', 'middle', 0, '0.00', '0', '0', 0, 'rgba(0,0,0,0)', '#008000', '0', '0', 'rgba(0,0,0,0)', '0', '0', '4', '0', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	...
	var _1 = CreText('_1', 85, 257, 624, 50, "Chính quyền cách mạng đã làm gì để thực hiện khẩu hiệu đất về tay dân cày?|Chia ruộng đất cho nông dân|Xóa bỏ các thứ thuế vô lí|Bãi bỏ các hủ tục|Đả phá tệ nạn xã hội|0", 'rgba(0,0,0,0)', '#ffffff', '#004080', '#ffffff', '', 18, 'Arial', 'Normal', 'left', 'middle', 3, '0.00', '5', '0', 1, '#0080ff', '#ffffff', '0', '0', 'rgba(0,0,0,0)', '0', '0', '4', '0', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	...
	var _2 = CreText('_2', 85, 316, 624, 50, "Sau cuộc biểu tình ngày 12 - 9 - 1930, làn sóng đấu tranh ở Nghệ Tĩnh như thế nào?|Càng thêm mạnh|Nông dân tiếp tục nổi dây|Đánh phá huyện lị, đồn điển...|Nhân đân cử ra người lãnh đạo|0", 'rgba(0,0,0,0)', '#ffffff', '#004080', '#ffffff', '', 18, 'Arial', 'Normal', 'left', 'middle', 3, '0.00', '5', '0', 1, '#0080ff', '#ffffff', '0', '0', 'rgba(0,0,0,0)', '0', '0', '4', '0', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	...
	var _3 = CreText('_3', 85, 376, 624, 50, "Trước khí thế đấu tranh của quản chúng, những kẻ đứng đầu chính quyền địch ở thôn, xã|Bỏ trốn|Sợ hãi|Đầu hàng|Bỏ trốn hoặc đầu hàng|3", 'rgba(0,0,0,0)', '#ffffff', '#004080', '#ffffff', '', 18, 'Arial', 'Normal', 'left', 'middle', 3, '0.00', '5', '0', 1, '#0080ff', '#ffffff', '0', '0', 'rgba(0,0,0,0)', '0', '0', '4', '0', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	...
	var Text_1 = CreText('Text_1', -13, 15, 146, 34, "Bài 8", 'rgba(0,0,0,0)', '#ffffff', 'rgba(0,0,0,0)', '#ffffff', '', 24, 'Arial', 'Bold', 'center', 'middle', 0, '0.00', '0', '0', 0, 'rgba(0,0,0,0)', '#dff9f9', '0', '0', '#0080c0', '0', '0', '4', '1', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
