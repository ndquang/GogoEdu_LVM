folder_Resource = '/data/trac_nghiem_lich_su_lop_5_3';
var cntQst = 20;
var _score = 0;
var _cSubmit = 0;
var _index = 1;
...
window.onload = function () {
	...
	var title = CreText('title', 0, 0, 749, 49, "Cuộc phản công ở kinh thành Huế", 'rgba(0,0,0,0)', '#ffffff', '#0080ff', '#ffffff', '', 26, 'Arial', 'Bold', 'center', 'middle', 0, '0.00', '0', '0', 0, 'rgba(0,0,0,0)', '#008000', '0', '0', 'rgba(0,0,0,0)', '0', '0', '4', '0', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	...
	var _1 = CreText('_1', 85, 257, 624, 50, "Lãnh đạo cuộc khởi nghĩa Ba Đình là:|Phạm Bành- Đinh Công Tráng|Nguyễn Thiện Thuật|Phan Đình Phùng|Phạm Bành- Nguyễn Thiện Thuật|0", 'rgba(0,0,0,0)', '#ffffff', '#004080', '#ffffff', '', 18, 'Arial', 'Normal', 'left', 'middle', 3, '0.00', '5', '0', 1, '#0080ff', '#ffffff', '0', '0', 'rgba(0,0,0,0)', '0', '0', '4', '0', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	...
	var _2 = CreText('_2', 85, 316, 624, 50, "Bãi sậy thuộc tỉnh|Hà Tĩnh|Thanh Hóa|Quảng Trị|Hưng Yên|3", 'rgba(0,0,0,0)', '#ffffff', '#004080', '#ffffff', '', 18, 'Arial', 'Normal', 'left', 'middle', 3, '0.00', '5', '0', 1, '#0080ff', '#ffffff', '0', '0', 'rgba(0,0,0,0)', '0', '0', '4', '0', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	...
	var _3 = CreText('_3', 85, 376, 624, 50, "Cuộc khởi nghĩa nào thuộc phong trào khởi nghĩa hưởng ứng Chiếu Cần Vương?|Khởi nghĩa Ba Đình (Thanh Hóa).|Khởi nghĩa Bãi Sậy (Hưng Yên)|Khởi nghĩa Hương Khê (Hà Tĩnh)|Cả A, B và C đúng|3", 'rgba(0,0,0,0)', '#ffffff', '#004080', '#ffffff', '', 18, 'Arial', 'Normal', 'left', 'middle', 3, '0.00', '5', '0', 1, '#0080ff', '#ffffff', '0', '0', 'rgba(0,0,0,0)', '0', '0', '4', '0', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	...
	var Text_5 = CreText('Text_5', 20, 314, 59, 46, "C.", 'rgba(0,0,0,0)', '#ffffff', '#000000', '#ffffff', '', 16, 'Arial', 'Normal', 'center', 'middle', 0, '0.00', '0', '0', 0, 'rgba(0,0,0,0)', '#ffffff', '0', '0', 'rgba(0,0,0,0)', '0', '0', '4', '0', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	...
	var Text_1 = CreText('Text_1', 3, 10, 146, 34, "Bài 3", 'rgba(0,0,0,0)', '#ffffff', 'rgba(0,0,0,0)', '#ffffff', '', 24, 'Arial', 'Bold', 'center', 'middle', 0, '0.00', '0', '0', 0, 'rgba(0,0,0,0)', '#dff9f9', '0', '0', '#0080c0', '0', '0', '4', '1', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	...
	var Text_2 = CreText('Text_2', 20, 258, 59, 46, "B.", 'rgba(0,0,0,0)', '#ffffff', '#000000', '#ffffff', '', 16, 'Arial', 'Normal', 'center', 'middle', 0, '0.00', '0', '0', 0, 'rgba(0,0,0,0)', '#ffffff', '0', '0', 'rgba(0,0,0,0)', '0', '0', '4', '0', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	Page_1.add(Page_1_Backrounnd, title, sound, index, check, msg, txtFinish, _0, _1, _2, _3, Text_5, Text_6, _cauhoi, Text_1, Text_3, Text_2);
	stage.add(Page_1);
	InitLacVietScript();
};
