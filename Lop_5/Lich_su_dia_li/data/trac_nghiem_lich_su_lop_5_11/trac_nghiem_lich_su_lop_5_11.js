folder_Resource = '/data/trac_nghiem_lich_su_lop_5_11';
var cntQst = 20;
var _score = 0;
var _cSubmit = 0;
var _index = 1;
...
window.onload = function () {
	...
	var title = CreText('title', 106, 9, 637, 75, "Ôn tập – Hơn tám mươi năm chống thực dân Pháp xâm lược và đô hộ (1858 – 1945) ", 'rgba(0,0,0,0)', '#ffffff', '#0080ff', '#ffffff', '', 26, 'Arial', 'Bold', 'center', 'middle', 0, '0.00', '0', '0', 0, 'rgba(0,0,0,0)', '#008000', '0', '0', 'rgba(0,0,0,0)', '0', '0', '4', '0', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	...
	var _1 = CreText('_1', 85, 257, 624, 50, "Hội nghị thành lập Đảng vào thời gian:\r\n|1/2/1930\r\n|2/2/1930\r\n|3/2/1930\r\n|4/2/1930|2", 'rgba(0,0,0,0)', '#ffffff', '#004080', '#ffffff', '', 18, 'Arial', 'Normal', 'left', 'middle', 3, '0.00', '5', '0', 1, '#0080ff', '#ffffff', '0', '0', 'rgba(0,0,0,0)', '0', '0', '4', '0', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	...
	var _2 = CreText('_2', 85, 316, 624, 50, "Ngay sau cuộc mít tinh, quần chúng đã xông vào chiếm .........: Phủ Khâm sai, Sở mật thám…\r\n|Các trụ sở chính\r\n|Các cơ sở đầu não của kẻ thù\r\n|Các cơ quan làm việc của kẻ thù\r\n|Các tòa nhà lớn|1", 'rgba(0,0,0,0)', '#ffffff', '#004080', '#ffffff', '', 18, 'Arial', 'Normal', 'left', 'middle', 3, '0.00', '5', '0', 1, '#0080ff', '#ffffff', '0', '0', 'rgba(0,0,0,0)', '0', '0', '4', '0', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	...
	var _3 = CreText('_3', 85, 376, 624, 50, "Ngày 2/9/1945 trên quảng trường Ba Đình lịch sử, Chủ tịch HCM đọc bản Tuyên ngôn độc lập, khai sinh ra nước VNDCCH, đó là ngày................ của nước ta.\r\n|Kỉ niệm ngày toàn dân Hà Nội ăn mừng chiến thắng\r\n|Mừng Hà Nội toàn thắng\r\n|Quốc khánh\r\n|Kỉ niệm Hà Nội chiến thắng|2", 'rgba(0,0,0,0)', '#ffffff', '#004080', '#ffffff', '', 18, 'Arial', 'Normal', 'left', 'middle', 3, '0.00', '5', '0', 1, '#0080ff', '#ffffff', '0', '0', 'rgba(0,0,0,0)', '0', '0', '4', '0', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	...
	var Text_1 = CreText('Text_1', -1, 15, 134, 34, "Bài 11", 'rgba(0,0,0,0)', '#ffffff', 'rgba(0,0,0,0)', '#ffffff', '', 24, 'Arial', 'Bold', 'center', 'middle', 0, '0.00', '0', '0', 0, 'rgba(0,0,0,0)', '#dff9f9', '0', '0', '#0080c0', '0', '0', '4', '1', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
