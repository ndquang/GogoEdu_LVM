folder_Resource ='/data/tri_dung_song_toan';
var doan_van="";
var cau_van="";
var Startdot= 0;
var Enddot= 0;
...
var content = CreText('content',17,320,467,180,"      Thấy sứ thần Việt Nam dám lấy việc quân đội cả ba triều đại Nam Hán, Tống và Nguyên đều thảm bại trên sông Bạch Đằng để đối lại, vua Minh giận quá sai người ám hại ông.\r\nThi hài Giang Văn Minh được đưa về nước. Vua Lê Thần Tông đến tận linh cữu ông, khóc rằng:\r\n- Sứ thần không làm nhục mệnh vua, xứng đáng là anh hùng thiên cổ.\r\nĐiếu văn của vua Lê còn có câu: “Ai cũng sống, sống như ông, thật đáng sống. Ai cũng chết, chết như ông, chết như sống”.\r\n",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var bt_nghe_viet = CreText('bt_nghe_viet',208,282,144,24,"Nghe viết chính tả",'#004080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#666666','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var title = CreText('title',-2,-2,502,27,"Trí dũng song toàn",'rgba(0,0,0,0)','#ffffff','#004080','#004080','',14,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#004080','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.50);
var bt_NgheAll = CreText('bt_NgheAll',90,282,106,24,"Nghe cả bài",'#004080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#666666','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var txtDiem = CreText('txtDiem',365,282,69,24,"Điểm",'#004080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#666666','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
