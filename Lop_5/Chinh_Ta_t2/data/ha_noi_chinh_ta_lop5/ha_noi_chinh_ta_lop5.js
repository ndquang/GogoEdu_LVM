folder_Resource ='/data/ha_noi_chinh_ta_lop5';
var doan_van="";
var cau_van="";
var Startdot= 0;
var Enddot= 0;
...
var content = CreText('content',8,87,228,277,"Hà Nội có chong chóng\r\nCứ tự xoay trong nhà\r\nKhông cần trời nổi gió\r\nKhông cần bạn chạy xa.\r\n\r\nHà Nội có Hồ Gươm\r\nNước xanh như pha mực\r\nBên hồ ngọn Tháp Bút\r\nViết thơ lên trời cao.\r\n\r\nMấy năm giặc bắn phá\r\nBa Đình vẫn xanh cây\r\nTrăng vàng chùa Một Cột\r\nPhủ Tây Hồ hoa bay….",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var bt_nghe_viet = CreText('bt_nghe_viet',212,368,144,24,"Nghe viết chính tả",'#004080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#ffffff','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var title = CreText('title',0,-2,500,27,"Hà Nội",'rgba(0,0,0,0)','#ffffff','#004080','#ffffff','',16,'Arial','Bold','center','middle',0,'0.00','0','1',1,'#004080','#000000','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var bt_NgheAll = CreText('bt_NgheAll',94,368,106,24,"Nghe cả bài",'#004080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#ffffff','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var txt_input = CreText('txt_input',233,89,252,257,"",'#ffffff','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',1,'#004080','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.50);
...
var txtDiem = CreText('txtDiem',369,368,69,24,"Điểm",'#004080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#ffffff','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
