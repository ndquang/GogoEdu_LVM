folder_Resource ='/data/lich_su_ngay_quoc_te_lao_dong';
var doan_van="";
var cau_van="";
var Startdot= 0;
var Enddot= 0;
...
var Page_1_Backrounnd = CreText('Page_1_Backrounnd',0,0,500,580,'','#ffffff','','','','',12,'Times New Roman','','left','center',0,'0.00','0',0,'0',0,'#ffffff','0','0','0','','0','0','0','0',0,0,'');
var content = CreText('content',14,365,467,214,"Ngày 1-5-1886, công nhân thành phố Chi-ca-gô, nước Mĩ, xuống đường biểu tình đòi làm việc theo chế độ 8 giờ một ngày. Từ Chi-ca-gô, làn sóng bãi công lan nhanh ra các thành phố Niu Y-oóc, Ban-ti-mo, Pít-sbơ-nơ,… Các cuộc biểu tình bị đàn áp nặng nề. Đặc biệt, ở Chi-ca-gô, cảnh sát đã xả súng vào đoàn người tay không, làm hàng trăm người chết và bị thương. Nhưng cuối cùng, giới chủ phải chấp nhận yêu sách của công nhân. Để ghi nhớ sự kiện này, ngày 1-5 hằng năm đã được chọn làm ngày biểu dương lực lượng của giai cấp công nhân toàn thế giới.",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.80);
var bt_nghe_viet = CreText('bt_nghe_viet',195,333,144,24,"Nghe viết chính tả",'#004080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#666666','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var title = CreText('title',-2,-2,502,27,"Lịch sử Ngày Quốc tế Lao động",'rgba(0,0,0,0)','#ffffff','#004080','#004080','',14,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#004080','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.50);
var bt_NgheAll = CreText('bt_NgheAll',77,333,106,24,"Nghe cả bài",'#004080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#666666','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var txt_input = CreText('txt_input',24,86,459,234,"",'#ffffff','#ffffff','#000000','#ff6820','',14,'Arial','Normal','left','top',0,'0.00','0','0',1,'#004080','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.50);
...
var txtDiem = CreText('txtDiem',352,333,69,24,"Điểm",'#004080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#666666','#004080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
