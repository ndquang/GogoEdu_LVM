folder_Resource = '/data/trac_nghiem_dia_li_5_1';
var cntQst = 12;
var _score = 0;
var _cSubmit = 0;
var _index = 1;
...
window.onload = function () {
	...
	var title = CreText('title', 106, 9, 637, 75, "Việt Nam - đất nước chúng ta", 'rgba(0,0,0,0)', '#ffffff', '#0080ff', '#ffffff', '', 26, 'Arial', 'Bold', 'center', 'middle', 0, '0.00', '0', '0', 0, 'rgba(0,0,0,0)', '#008000', '0', '0', 'rgba(0,0,0,0)', '0', '0', '4', '0', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	...
	var Text_1 = CreText('Text_1', -1, 15, 134, 34, "Bài 1", 'rgba(0,0,0,0)', '#ffffff', 'rgba(0,0,0,0)', '#ffffff', '', 24, 'Arial', 'Bold', 'center', 'middle', 0, '0.00', '0', '0', 0, 'rgba(0,0,0,0)', '#dff9f9', '0', '0', '#0080c0', '0', '0', '4', '1', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
