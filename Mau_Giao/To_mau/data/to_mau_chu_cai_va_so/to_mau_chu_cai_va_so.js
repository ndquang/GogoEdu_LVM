folder_Resource ='data/to_mau_chu_cai_va_so';
...
var object_0 = CreText('object_0',35,102,537,304,"a",'#ffffff','#ffffff','#ffffff','#ffffff','',244,'Arial','Bold','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','#000000','0','0','4','2',0,0,'rgba(0,0,0,0)',0,1.50);
var tx = CreText('tx',0,411,639,65,"",'#aa55ff','#ffffff','#000000','#ffffff','',16,'Arial','Normal','center','middle',7,'0.00','11','13',1,'#ffffff','#aa55ff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var Color_0 = CreText('Color_0',572,427,37,37,"",'#005500','#ffe4e1','#ff6820','#ff6820','',14,'Verdana','Bold','left','middle',2,'0.00','33','75',1,'#ffffff','#005500','0','0','rgba(0,0,0,0)','1','1','4','3',2,1,'#ffffff',0,1.50);
...
var Color_1 = CreText('Color_1',29,427,37,37,"",'#8b0000','#ffffff','#000000','#ffffff','',18,'Verdana','Normal','center','middle',2,'0.00','33','75',1,'#ffffff','#8b0000','0','0','rgba(0,0,0,0)','0','0','4','1',1,1,'#c0c0c0',0,1.50);
...
var Color_2 = CreText('Color_2',160,427,37,37,"",'#804000','#ffffff','#000000','#ffffff','',18,'Verdana','Normal','center','middle',2,'0.00','33','75',1,'#ffffff','#804000','0','0','rgba(0,0,0,0)','0','0','4','1',1,1,'#ffffff',0,1.50);
...
var Color_3 = CreText('Color_3',480,427,37,37,"",'#4b0082','#ffffff','#000000','#ffffff','',18,'Verdana','Normal','center','middle',2,'0.00','33','75',1,'#ffffff','#4b0082','0','0','rgba(0,0,0,0)','0','0','4','1',1,1,'#ffffff',0,1.50);
...
var Color_4 = CreText('Color_4',115,427,37,37,"",'#ff6820','#ffffff','#000000','#ffffff','',18,'Verdana','Normal','center','middle',2,'0.00','33','75',1,'#ffffff','#ff6820','0','0','rgba(0,0,0,0)','0','0','4','1',1,1,'#c0c0c0',0,1.50);
...
var Color_5 = CreText('Color_5',525,427,37,37,"",'#00ff00','#ffffff','#000000','#ffffff','',18,'Verdana','Normal','center','middle',2,'0.00','33','75',1,'#ffffff','#00ff00','0','0','rgba(0,0,0,0)','0','0','4','1',1,1,'#ffffff',0,1.50);
...
var Color_6 = CreText('Color_6',210,427,37,37,"",'#0000ff','#ffffff','#000000','#ffffff','',18,'Verdana','Normal','center','middle',2,'0.00','33','75',1,'#ffffff','#0000ff','0','0','rgba(0,0,0,0)','0','0','4','1',1,1,'#ffffff',0,1.50);
...
var Color_7 = CreText('Color_7',70,427,37,37,"",'#ff0000','#ffffff','#000000','#ffffff','',18,'Verdana','Normal','center','middle',2,'0.00','33','75',1,'#ffffff','#ff0000','0','0','rgba(0,0,0,0)','0','0','4','1',1,1,'#c0c0c0',0,1.50);
...
var Color_8 = CreText('Color_8',345,427,37,37,"",'#000000','#ffffff','#000000','#ffffff','',18,'Verdana','Normal','center','middle',2,'0.00','33','75',1,'#ffffff','#000000','0','0','rgba(0,0,0,0)','0','0','4','1',1,1,'#ffffff',0,1.50);
...
var Color_10 = CreText('Color_10',390,427,37,37,"",'#ffff00','#000000','#ff6820','#ff6820','',14,'Verdana','Bold','center','middle',2,'0.00','33','75',1,'#ffffff','#ffff00','0','0','rgba(0,0,0,0)','2','2','4','3',1,1,'#ffffff',0,1.50);
...
var Color_11 = CreText('Color_11',255,427,37,37,"",'#00ffff','#ffffff','#000000','#ffffff','',18,'Verdana','Normal','center','middle',2,'0.00','33','75',1,'#ffffff','#00ffff','0','0','rgba(0,0,0,0)','0','0','4','1',1,1,'#ffffff',0,1.50);
...
var Color_12 = CreText('Color_12',300,427,37,37,"",'#0080ff','#ffffff','#000000','#ffffff','',18,'Verdana','Normal','center','middle',2,'0.00','33','75',1,'#ffffff','#0080ff','0','0','rgba(0,0,0,0)','0','0','4','1',1,1,'#ffffff',0,1.50);
...
var Color_13 = CreText('Color_13',435,427,37,37,"",'#ff00ff','#ffffff','#000000','#ffffff','',18,'Verdana','Normal','center','middle',2,'0.00','33','75',1,'#ffffff','#ff00ff','0','0','rgba(0,0,0,0)','0','0','4','1',1,1,'#ffffff',0,1.50);
...
var Color_14 = CreText('Color_14',580,109,50,50,"●",'rgba(0,0,0,0)','#ffffff','#ffff00','#ffff00','',16,'Arial','Bold','center','middle',2,'0.00','0','0',2,'#ffffff','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'#c0c0c0',0,1.50);
...
var Color_15 = CreText('Color_15',580,170,50,50,"●",'rgba(0,0,0,0)','#ffffff','#ffff00','#ffff00','',26,'Arial','Bold','center','middle',2,'0.00','0','0',2,'#ffffff','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'#c0c0c0',0,1.50);
...
var Color_16 = CreText('Color_16',580,231,50,50,"●",'rgba(0,0,0,0)','#ffffff','#ffff00','#ffff00','',36,'Arial','Bold','center','middle',2,'0.00','0','0',2,'#ffffff','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'#c0c0c0',0,1.50);
...
var Color_18 = CreText('Color_18',581,292,50,50,"█\r\n",'rgba(0,0,0,0)','#ffffff','#ffff00','#ffff00','',14,'Arial','Bold','center','middle',2,'34.00','0','0',2,'#ffffff','#ffffff','0','0','#000000','0','0','4','1',0,0,'#c0c0c0',0,1.50);
...
var Color_20 = CreText('Color_20',577,355,56,39,"Save",'#400080','#ffffff','#ffff00','#ffff00','',16,'Arial','Bold','center','middle',3,'0.00','3','13',2,'#ffffff','#400080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
