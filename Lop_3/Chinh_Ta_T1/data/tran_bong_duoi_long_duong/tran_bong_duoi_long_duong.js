folder_Resource ='/data/tran_bong_duoi_long_duong';
var doan_van="";
var cau_van="";
var Startdot= 0;
var Enddot= 0;
...
dem_doc++;
if(wordCountStr(cau_van)>0 && cau_van!="" && cau_van!="." && cau_van!="!")
{
...
var content = CreText('content',22,32,476,125,"Một chiếc xích lô xịch tới. Bác đứng tuổi vừa dìu ông cụ lên xe, vừa bực bội:\r\n     Thật là quá quắt!\r\n    Quang sợ tái cả người. Cậu bống thấy cái lưng còng của ông cụ sao giống lưng ông nội thế. Cậu bé vừa chạy theo chiếc xích lô, vừa mếu máo:\r\n     Ông ơi... cụ ơi...! Cháu xin lỗi cụ.",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var txt_input = CreText('txt_input',35,184,465,142,"",'#ffffff','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',1,'#666666','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.50);
