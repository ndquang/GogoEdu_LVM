folder_Resource ='/data/nha_rong_o_tay_nguyen';
var doan_van="";
var cau_van="";
var Startdot= 0;
var Enddot= 0;
...
var content = CreText('content',22,32,476,125,"     Gian đầu nhà rông là nơi thờ thần làng, trên vách treo một giỏ mây đựng hòn đá thần. Đó là hòn đá mà già làng nhặt lấy khi chọn đất lập làng. Xung quanh hòn đá thần, người ta treo những cành hoa đan bằng tre, vũ khí, nông cụ của cha ông truyền lại và chiêng trống dùng khi cúng tế.",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var title = CreText('title',1,-1,498,25,"Nhà rông ở Tây Nguyên",'#008080','#ffffff','#ffffff','#ffffff','',16,'Arial','Bold','center','middle',0,'0.00','0','0',2,'#ffffff','#008080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
