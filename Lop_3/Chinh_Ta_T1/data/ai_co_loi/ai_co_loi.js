folder_Resource ='/data/ai_co_loi';
var doan_van="";
var cau_van="";
var Startdot= 0;
var Enddot= 0;
...
var content = CreText('content',16,32,467,89,"     Cơn giận lắng xuống. Tôi bắt đầu thấy hối hận. Chắc là Cô-rét-ti không cố ý chạm vào khuỷu tay tôi thật. Tôi nhìn cậu, thấy vai áo cậu sứt chỉ, chắc là vì cậu đã vác củi giúp mẹ. Bỗng nhiên tôi muốn xin lỗi Cô-rét-ti, nhưng không đủ can đảm.",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
