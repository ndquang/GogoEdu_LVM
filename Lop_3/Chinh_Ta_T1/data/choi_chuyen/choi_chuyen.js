folder_Resource ='/data/choi_chuyen';
var doan_van="";
var cau_van="";
var Startdot= 0;
var Enddot= 0;
...
var content = CreText('content',16,32,219,338,"Chuyền chuyền một\r\nMột, một đôi\r\nChuyền chuyền Hai\r\nHai, hai đôi\r\nMắt sáng ngời\r\nTheo hòn cuội\r\nTay mềm mại\r\nVơ que chuyền.\r\nMai lớn lên\r\nVào nhà máy\r\nCông nhân mới\r\nGiữa dây chuyền\r\nĐón bạn trên\r\nChuyền bạn dưới\r\nMắt không mỏi\r\nTay không rời\r\nChuyền dẻo dai\r\nChuyền chuyền mãi.",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var txt_inputTitle = CreText('txt_inputTitle',256,4,222,25,"",'#ffffff','#ffffff','#000000','#ffffff','',16,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#7f7f7f','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var msg = CreText('msg',162,4,97,25,"",'rgba(0,0,0,0)','#ffffff','#ffffff','#ffffff','',12,'Arial','Italic','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var xtimer = CreText('xtimer',131,4,26,25,"",'rgba(0,0,0,0)','#ffffff','#ff6820','#ffffff','',16,'Arial','Normal','right','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var Text_2 = CreText('Text_2',64,347,177,20,"THÁI HOÀNG LINH",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
