folder_Resource ='data/bang_nhan_6';
var keyOldValue="";
var keyNewValue="";
var objectShowKey="";
...
{	
	for(var k=0; k< 11;k++)
	{	
			SetText("","chu_"+k,"6 x "+ k + "=");
			SetText("","so_"+k,6*k);
	}
	for(k=11; k< 16;k++)
	{	
			var x= Random(11);
			SetText("","chu_"+k,x+" x 6"+ "=");
			SetText("","so_"+k,6*x);
	}
...
function Init3(){
		var a= Random(6)+4;
		var tt= "Mỗi học sinh mua 6 quyển vở. Hỏi ... học sinh mua bao nhiêu quyển vở?";
...
function Init4(){
		var a= Random(6)+4;
		var tt= "Mỗi ngày có 24 giờ. Hỏi ... ngày có bao nhiêu giờ?";
		tt= replaceStr(tt,"...",a,0,1);
		SetText("","chu_25",tt);
		SetText("","so_25",24*a);
}
...
var Page_1_Backrounnd = CreText('Page_1_Backrounnd',0,0,520,590,'','#ffffff','','','','ID_IMAGE4.PNG',12,'Times New Roman','','left','center',0,'0.00','0',0,'0',0,'#ffffff','2','2','0','','0','0','0','0',0,0,'');
var chu_25 = CreText('chu_25',67,367,438,22,"Mỗi ngày có 24 giờ. Hỏi ... ngày có bao nhiêu giờ?",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var chu_24 = CreText('chu_24',70,328,428,41,"Mỗi học sinh mua 6 quyển vở. Hỏi ... học sinh mua bao nhiêu quyển vở?",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.70);
var Text_1 = CreText('Text_1',0,0,520,32,"BẢNG NHÂN 6",'rgba(255,255,255,0.44)','#ffffff','#000000','#ffffff','',18,'Arial','Normal','center','middle',0,'0.00','0','1',1,'#ff0000','rgba(255,255,255,0.44)','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var Text_2 = CreText('Text_2',18,329,62,25,"Bài 3:",'rgba(0,0,0,0)','#ffffff','#0000ff','#ffffff','',16,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var so_24 = CreText('so_24',147,345,28,21,"8",'rgba(255,255,255,0.67)','#ffffff','#000000','#ffffff','',14,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#0000ff','rgba(255,255,255,0.67)','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var so_25 = CreText('so_25',397,364,30,22,"8",'rgba(255,255,255,0.67)','#ffffff','#000000','#ffffff','',14,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#0000ff','rgba(255,255,255,0.67)','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var bai_4 = CreText('bai_4',18,364,49,25,"Bài 4:",'rgba(0,0,0,0)','#ffffff','#0000ff','#ffffff','',16,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var text_xx6 = CreText('text_xx6',66,395,359,21,"Hai phép tính nào sau đây có kết quả bằng nhau?",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var m_diem = CreText('m_diem',157,184,252,141,"8",'rgba(236,217,255,1.11)','#ffffff','#8000ff','#ffffff','',48,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#ffffff','rgba(236,217,255,1.11)','0','0','#ffffff','0','0','4','1',0,0,'rgba(0,0,0,0)',0,1.50);
var t_mess = CreText('t_mess',158,185,252,21,"Game cho con",'rgba(64,0,128,1.11)','#ffffff','#ffffff','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','0',1,'#ffffff','rgba(128,0,255,1.11)','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var bt_lam_lai = CreText('bt_lam_lai',231,285,95,25,"® Làm Lại",'#400080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#ffffff','#8000ff','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var label = CreText('label',158,210,251,24,"Bạn được",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',18,'Arial','Normal','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var Text_17 = CreText('Text_17',373,185,37,21,"x",'#ff0000','#ffffff','#ffffff','#ffffff','',16,'Arial','Normal','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#8b0000','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var Text_14 = CreText('Text_14',480,0,40,32,"®",'#400080','#ffffff','#ffffff','#ffffff','',16,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#ffffff','#8000ff','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
