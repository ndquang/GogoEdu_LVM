folder_Resource ='data/tieng_viet_3_t2';
...
var msg = CreText('msg',34,763,455,28,"",'rgba(0,0,0,0)','#ffffff','#ff0000','#ffffff','',16,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var question = CreText('question',50,522,685,61,"",'rgba(0,0,0,0)','#ffffff','#004080','#ffffff','',18,'Segoe UI','Normal','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var answer = CreText('answer',23,598,682,153,"",'#ffffff','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',1,'#00ccff','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.70);
var bt_Check = CreText('bt_Check',390,763,97,28,"Nộp bài",'#40e0d0','#ffffff','#282828','#ffffff','',16,'Arial','Bold','center','middle',3,'0.00','3','0',1,'#ffd700','#c0ffff','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var header = CreText('header',62,10,654,76,"Title",'rgba(0,0,0,0)','#ffffff','#009f9f','#ffffff','',28,'Arial','Bold','center','middle',12,'0.00','0','2',6,'#ffd700','#009300','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var passage = CreText('passage',23,169,682,336,"",'#eaffff','#fffaf9','#000000','#ffffff','',14,'Arial','Normal','left','top',3,'0.00','5','0',1,'#00ccff','#eaffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',15,1.80);
var unit = CreText('unit',26,7,79,81,"Bài",'#00d7d7','#ff6820','#ffffff','#ffffff','',16,'Arial Unicode MS','Bold','center','top',2,'0.00','0','3',6,'#ffd700','#009f9f','3','1','rgba(0,0,0,0)','0','0','4','0',0,0, 'rgba(0,0,0,0)',3,1.50);
...
var author = CreText('author',427,476,269,31,"tác gia",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',14,'Arial','Italic','center','middle',3,'0.00','5','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var bt_Next = CreText('bt_Next',639,763,74,28,"Next",'#e0e0e0','#ffffff','#000000','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#282828','#e5e5e5','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var cau = CreText('cau',566,763,97,28,"2/10",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',18,'Arial','Normal','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var bt_Prev = CreText('bt_Prev',511,763,74,28,"Prev",'#e0e0e0','#ffffff','#000000','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#282828','#e5e5e5','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var section1 = CreText('section1',25,102,120,35,"I. ĐỌC",'#ffffe0','#ffe4e1','#008080','#ffffff','',14,'Arial','Bold','center','middle',12,'0.00','0','1',5,'#ffd700','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var id = CreText('id',21,537,30,34,"1.",'rgba(0,0,0,0)','#ffffff','#ff0000','#ffffff','',20,'Arial','Bold','center','middle',2,'0.00','0','0',0,'rgba(0,0,0,0)','#009300','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var section2 = CreText('section2',159,102,200,35,"II. NGHE VÀ VIẾT",'#ffffe0','#ffe4e1','#008080','#ffffff','',14,'Arial','Bold','center','middle',12,'0.00','2','1',5,'#ffd700','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var btnPlay = CreText('btnPlay',331,489,88,33,"🔊",'#ffffff','#ffffff','#0080c0','#ffffff','',16,'Arial Unicode MS','Normal','center','bottom',3,'0.00','10','0',2,'#0080c0','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.70);
...
var title = CreText('title',88,151,557,35,"1 ",'#ffffff','#ccffcc','#ff6820','#ffffff','',18,'Arial','Bold','center','middle',12,'0.00','2','2',1,'#00ccff','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
