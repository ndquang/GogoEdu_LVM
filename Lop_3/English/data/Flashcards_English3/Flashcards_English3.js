folder_Resource ='data/Flashcards_English3';
...
if (typeof responsiveVoice !== 'undefined')
	responsiveVoice.speak(currentObject.en,"US English Female", { pitch: 1, rate: 0.6 });
...
function OpenRever()
{
	if(currentObject!=null)
		...
		SetText("","msg",currentObject.ipa + " ("+currentObject.pos+")");
...
if(i_mode == 0) // view
...
else if(i_mode == 1) 
	{
		...
		if (checkAnswer(_strInput)) {
			...
			if (typeof responsiveVoice !== 'undefined')
		responsiveVoice.speak(currentObject.eg,"US English Female", { pitch: 1, rate: 0.6 });
...
var header = CreText('header',129,3,510,60,"Local Community",'rgba(0,0,0,0)','#ffffff','#ff5300','#ffffff','',36,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#ff5300','#f79323','0','0','#666666','0','0','4','1',0,0,'rgba(0,0,0,0)',0,1.50);
var unit = CreText('unit',1,2,127,61,"Unit 1",'#ff0000','#ffffff','#ffffff','#ffffff','',22,'Arial Black','Normal','center','middle',12,'0.00','0','3',0,'rgba(0,0,0,0)','#8b0000','4','1','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var card = CreText('card',131,107,383,208,"",'#ffe287','#ffffff','#000000','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','10','0',4,'#8b0000','#ffe287','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var msg = CreText('msg',139,203,372,60,"",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',18,'Arial','Normal','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','1',0,0,'rgba(0,0,0,0)',0,1.50);
