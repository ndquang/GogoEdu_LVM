folder_Resource ='/data/hoi_dua_voi_o_tay_nguyen';
var doan_van="";
var cau_van="";
var Startdot= 0;
var Enddot= 0;
...
var content = CreText('content',22,32,464,94,"     Đến giờ xuất phát, chiêng trống nổi lên thì cả mười con voi lao đầu chạy. Cái dáng lầm lì, chậm chạp thường ngày bỗng dưng biến mất, cả bầy hăng máu chạy như bay. Bụi cuốn mù mịt. Các chàng trai man-gát phải rất gan dạ và khéo léo điều khiển cho voi về trúng đích.",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var Text_2 = CreText('Text_2',252,93,220,25,"theo LÊ TẤN",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',12,'Arial','Bold','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var Text_3 = CreText('Text_3',255,303,144,24,"Nghe viết chính tả",'#008080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#ffffff','#008080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var title = CreText('title',1,-1,498,25,"Hội đua voi ở Tây Nguyên",'#008080','#ffffff','#ffffff','#ffffff','',16,'Arial','Bold','center','middle',0,'0.00','0','0',2,'#ffffff','#008080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var Text_1 = CreText('Text_1',137,303,106,24,"Nghe cả bài",'#008080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#ffffff','#008080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var txt_input = CreText('txt_input',35,152,446,142,"",'#ffffff','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',1,'#666666','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.50);
var txt_inputTitle = CreText('txt_inputTitle',82,121,338,25,"",'#ffffff','#ffffff','#000000','#ffffff','',16,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#7f7f7f','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var txtDiem = CreText('txtDiem',412,303,69,24,"Điểm",'#008080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#ffffff','#008080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
