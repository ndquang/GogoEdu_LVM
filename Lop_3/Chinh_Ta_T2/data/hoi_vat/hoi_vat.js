...
var content = CreText('content',22,32,460,125,"     Tiếng trống dồn lên, gấp rút, giục giã. Ông Cản Ngũ vẫn chưa ngã. Ông vẫn đứng như cây trồng giữa sới. Còn Quắm Đen thì đang loay hoay, gò lưng lại, không sao bê nổi chân ông lên. Cái chân tựa như bằng cột sắt chứ không phải là chân người nữa.\r\n      Ông Cản Ngũ vẫn đứng nghiêng mình nhìn Quắm Đen mồ hôi mồ kê nhễ nhại dưới chân. ",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var title = CreText('title',1,-1,498,25," Hội vật",'#008080','#ffffff','#ffffff','#ffffff','',16,'Arial','Bold','center','middle',0,'0.00','0','0',2,'#ffffff','#008080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
