folder_Resource ='/data/Doi_dap_voi_vua';
var doan_van="";
var cau_van="";
var Startdot= 0;
var Enddot= 0;
...
var content = CreText('content',22,32,460,125,"Thấy nói là học trò, vua ra lệnh cho cậu phải đối được một vế đối thì mới tha. Nhìn thấy trên mặt hồ lúc đó có đàn cá đang đuổi nhau, vua tức cảnh đọc vế đối như sau:\r\n                      Nước trong leo lẻo cá đớp cá\r\nChẳng cần nghĩ ngợi lâu la gì, Cao Bá Quát lấy cảnh mình đang bị trói, đối lại luôn:\r\n                     Trời nắng chang chang người trói người.",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var title = CreText('title',1,-1,498,25,"Đối đáp với vua",'#008080','#ffffff','#ffffff','#ffffff','',16,'Arial','Bold','center','middle',0,'0.00','0','0',2,'#ffffff','#008080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
