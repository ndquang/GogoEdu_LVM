folder_Resource ='/data/bac_sy_e-et-xanh';
var doan_van="";
var cau_van="";
var Startdot= 0;
var Enddot= 0;
...
var txt_input = CreText('txt_input',35,170,446,156,"",'#ffffff','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',1,'#666666','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.50);
var content = CreText('content',22,32,463,102,"     Tuy nhiên, tôi với bà, chúng ta đang sống chung trong một ngôi nhà: trái đất. Trái đất đích thực là ngôi nhà của chúng ta. Những đứa con trong nhà phải thương yêu và có bổn phận giúp đỡ nhau. Tôi không thể rời khỏi Nha Trang này để sống một nơi nào khác. Chỉ có ở đây, tâm hồn tôi mới được rộng mở và bình yên.",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var Text_3 = CreText('Text_3',233,331,144,24,"Nghe viết chính tả",'#008080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#ffffff','#008080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var title = CreText('title',1,-1,498,25,"Bác sĩ Y-éc-xanh",'#008080','#ffffff','#ffffff','#ffffff','',16,'Arial','Bold','center','middle',0,'0.00','0','0',2,'#ffffff','#008080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var Text_1 = CreText('Text_1',115,331,106,24,"Nghe cả bài",'#008080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#ffffff','#008080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var txt_inputTitle = CreText('txt_inputTitle',86,135,338,25,"",'#ffffff','#ffffff','#000000','#ffffff','',16,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#7f7f7f','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var txtDiem = CreText('txtDiem',390,331,69,24,"Điểm",'#008080','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#ffffff','#008080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
Page_1.add(Page_1_Backrounnd,txt_input,content,Text_3,title,Text_1,txt_inputTitle,txtDiem,ketqua,msg,xtimer);
stage.add(Page_1);
InitLacVietScript();
};
