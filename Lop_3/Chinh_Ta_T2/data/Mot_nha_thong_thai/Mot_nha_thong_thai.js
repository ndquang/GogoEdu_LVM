folder_Resource ='/data/Mot_nha_thong_thai';
var doan_van="";
var cau_van="";
var Startdot= 0;
var Enddot= 0;
...
var content = CreText('content',22,32,460,125,"     Ông Trương Vĩnh Ký là người có hiểu biết rất rộng. Nhà thông thái này sử dụng thành thạo tới 26 ngôn ngữ, tham gia nhiều hội nghiên cứu quốc tế. Ông để lại cho chúng ta hơn 100 bộ sách có giá trị về ngôn ngữ, lịch sử, văn học, địa lí,... Người đương thời liệt ông vào hàng 18 nhà bác học nổi tiếng thế giới.\r\n\r\n",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var title = CreText('title',1,-1,498,25,"Một nhà thông thái",'#008080','#ffffff','#ffffff','#ffffff','',16,'Arial','Bold','center','middle',0,'0.00','0','0',2,'#ffffff','#008080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var txt_input = CreText('txt_input',35,152,446,149,"",'#ffffff','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',1,'#666666','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.50);
