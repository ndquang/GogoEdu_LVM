folder_Resource ='data/Writing_8';
...
var strVietNamese = CreText('strVietNamese',28,2,634,40,"Write 4–5 sentences about Tet holiday in Vietnam.",'rgba(0,0,0,0)','#ffffff','#ba3f50','#ffffff','',18,'Segoe UI','Bold','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var strEnglish = CreText('strEnglish',34,49,682,188,"",'#ffffff','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',1,'#ba3f50','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.70);
var bt_Check = CreText('bt_Check',585,247,132,44,"Nộp bài",'#ffe4e1','#ffffff','#ba3f50','#ffffff','',16,'Arial','Bold','center','middle',3,'0.00','10','0',2,'#ffc0cb','#ffe4e1','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var chat_output = CreText('chat_output',34,298,682,329,"",'#ffffff','#ffffff','#000000','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',1,'#ba3f50','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.70);
