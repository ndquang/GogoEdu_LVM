folder_Resource ='data/grammar_8';
var currentObject = {};
var index = 0;
...
var header = CreText('header',115,2,526,49,"Local Community",'#ff0080','#ffffff','#ffffff','#ffffff','',28,'Arial','Bold','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ff0080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var group = CreText('group',1,60,637,46,"Choose A,B,C or D to complete each sentence.",'rgba(0,0,0,0)','#ffffff','#ff0080','#ffffff','',16,'Arial','Normal','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var bt_Check = CreText('bt_Check',65,359,151,34,"Check Answers",'#ff0080','#ffffff','#ffffff','#ffffff','',16,'Arial','Bold','center','middle',3,'0.00','5','0',1,'#282828','#ff0080','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var Text_1 = CreText('Text_1',4,4,85,50,"Unit",'rgba(0,0,0,0)','#ffffff','#ff0080','#ffffff','',24,'Arial Black','Normal','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#000000','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var unit = CreText('unit',89,2,50,50,"1",'#d20069','#ffffff','#ffffff','#ffffff','',26,'Arial Black','Bold','center','middle',2,'0.00','0','0',3,'#ffffff','#d20069','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var id = CreText('id',9,111,44,51,"1.",'rgba(0,0,0,0)','#ffffff','#ff0080','#ffffff','',16,'Arial','Bold','right','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#009300','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
