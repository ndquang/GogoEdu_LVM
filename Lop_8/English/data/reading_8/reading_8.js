folder_Resource ='data/reading_8';
var currentObject = {};
var index = 0;
...
var header = CreText('header',157,1,482,39,"Local Community",'rgba(0,0,0,0)','#ffffff','#ba3f50','#ffffff','',28,'Arial','Bold','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ed5166','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var bt_Check = CreText('bt_Check',65,551,151,34,"Check Answers",'#ba3f50','#ffffff','#ffffff','#ffffff','',16,'Arial','Bold','center','middle',3,'0.00','5','0',1,'#282828','#ba3f50','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var options_0 = CreText('options_0',63,454,269,34,"",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',16,'Arial','Normal','left','middle',3,'0.00','5','0',1,'#ffc0cb','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var options_1 = CreText('options_1',349,454,271,34,"",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',16,'Arial','Normal','left','middle',3,'0.00','5','0',1,'#ffc0cb','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var options_2 = CreText('options_2',64,506,269,34,"",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',16,'Arial','Normal','left','middle',3,'0.00','5','0',1,'#ffc0cb','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var options_3 = CreText('options_3',346,506,269,34,"",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',16,'Arial','Normal','left','middle',3,'0.00','5','0',1,'#ffc0cb','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var unit = CreText('unit',0,1,127,35,"Unit 1",'#ed5166','#ffffff','#ffffff','#ffffff','',24,'Arial','Normal','center','middle',12,'0.00','0','3',0,'rgba(0,0,0,0)','#ed5166','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var id = CreText('id',9,407,44,51,"1.",'#ffffff','#ffffff','#ff0080','#ffffff','',16,'Arial','Bold','right','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var passage = CreText('passage',10,76,614,318,"",'rgba(255,192,203,0.53)','#ffffff','#000000','#ffffff','',16,'Arial Narrow','Normal','left','middle',3,'0.00','10','0',2,'#ffc0cb','rgba(255,192,203,0.53)','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.50);
var group = CreText('group',44,51,547,51,"Choose A,B,C or D to complete each sentence.",'#ffffff','#ffffff','#ba3f50','#ffffff','',18,'Arial','Normal','center','middle',3,'0.00','10','0',2,'#ffc0cb','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
