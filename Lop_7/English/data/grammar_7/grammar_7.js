folder_Resource ='data/grammar_7';
var currentObject = {};
var index = 0;
...
var header = CreText('header',115,2,526,49,"Local Community",'#0080ff','#ffffff','#ffffff','#ffffff','',28,'Arial','Bold','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#0080ff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var group = CreText('group',1,60,637,46,"Choose A,B,C or D to complete each sentence.",'rgba(0,0,0,0)','#ffffff','#0070df','#ffffff','',16,'Arial','Normal','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var bt_Check = CreText('bt_Check',65,359,151,34,"Check Answers",'#0070df','#ffffff','#ffffff','#ffffff','',16,'Arial','Bold','center','middle',3,'0.00','5','0',1,'#282828','#0070df','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var Text_1 = CreText('Text_1',4,4,85,50,"Unit",'rgba(0,0,0,0)','#ffffff','#0070df','#ffffff','',24,'Arial Black','Normal','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#000000','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var unit = CreText('unit',89,2,50,50,"1",'#0070df','#ffffff','#ffffff','#ffffff','',26,'Arial Black','Bold','center','middle',2,'0.00','0','0',3,'#ffffff','#0070df','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var id = CreText('id',9,111,44,51,"1.",'rgba(0,0,0,0)','#ffffff','#0070df','#ffffff','',16,'Arial','Bold','right','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#009300','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
