folder_Resource ='data/Vong_15_Toan_Lop_2';
var keyOldValue="";
var keyNewValue="";
var objectShowKey="";
...
function  CreateRam(){
   ...
   for (var i = 0; i < m_size; i++)
   {
	...
	arPhepTinh[Count]=iNN;
		...
		var x= leftStr(iNN,1);
		var y= subString(iNN,1,1);
		var z= rightStr(iNN,1);
		var a = Random(10-x);
		var b = Random(10-y);
		var c = Random(10-z);
		var so= a*100+b*10+c;
		arPhepTinh[Count]=iNN+" + "+so;
		arNumber[Count] =iNN+so;
     }
     else if(fep==2){
		var x= leftStr(iNN,1);
		var y= subString(iNN,1,1);
...
var Page_1_Backrounnd = CreText('Page_1_Backrounnd',0,0,450,310,'','#8000ff','','','','',12,'Times New Roman','','left','center',0,'0.00','0',0,'0',0,'#8000ff','0','0','0','','0','0','0','0',0,0,'');
var Text_3 = CreText('Text_3',13,62,428,235,"",'rgba(217,170,127,1.11)','#ffffff','#000000','#ffffff','',16,'Arial','Normal','center','middle',0,'0.00','0','0',8,'#aa7c41','rgba(217,170,127,1.11)','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var Text_2 = CreText('Text_2',11,7,428,39,"Vòng 15, bài 1",'#d9aa7f','#000000','#000000','#ffffff','',18,'Arial','Bold','left','middle',12,'0.00','0','1',2,'#aa7c41','#d9aa7f','0','0','rgba(0,0,0,0)','0','0','4','0',5,5,'#aa7c41',0,1.50);
var obj_view = CreText('obj_view',178,14,79,24,"",'#aa7c41','#ffffff','#ffffff','#ffffff','',10,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#ffffff','#aa7c41','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'#c0c0c0',0,1.50);
var Text_6 = CreText('Text_6',317,17,79,24,":",'#aa7c41','#ffffff','#ffff00','#ffffff','',18,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#ffffff','#aa7c41','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var o_so_0 = CreText('o_so_0',16,67,105,45,"",'#0080c0','#ffffff','#ffffff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',2,'#ffffff','#0080c0','0','0','rgba(0,0,0,0)','0','0','4','0',2,2,'#c0c0c0',0,1.50);
...
var o_so_1 = CreText('o_so_1',121,67,105,45,"",'#0080c0','#ffffff','#ffffff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',2,'#ffffff','#0080c0','0','0','rgba(0,0,0,0)','0','0','4','0',2,2,'#c0c0c0',0,1.50);
...
var o_so_2 = CreText('o_so_2',226,67,105,45,"",'#0080c0','#ffffff','#ffffff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',2,'#ffffff','#0080c0','0','0','rgba(0,0,0,0)','0','0','4','0',2,2,'#c0c0c0',0,1.50);
...
var o_so_3 = CreText('o_so_3',333,67,105,45,"",'#0080c0','#ffffff','#ffffff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',2,'#ffffff','#0080c0','0','0','rgba(0,0,0,0)','0','0','4','0',2,2,'#c0c0c0',0,1.50);
...
var o_so_4 = CreText('o_so_4',16,248,105,45,"",'#0080c0','#ffffff','#ffffff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',2,'#ffffff','#0080c0','0','0','rgba(0,0,0,0)','0','0','4','0',2,2,'#c0c0c0',0,1.50);
...
var o_so_5 = CreText('o_so_5',16,112,105,45,"",'#0080c0','#ffffff','#ffffff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',2,'#ffffff','#0080c0','0','0','rgba(0,0,0,0)','0','0','4','0',2,2,'#c0c0c0',0,1.50);
...
var o_so_6 = CreText('o_so_6',121,112,105,45,"",'#0080c0','#ffffff','#ffffff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',2,'#ffffff','#0080c0','0','0','rgba(0,0,0,0)','0','0','4','0',2,2,'#c0c0c0',0,1.50);
...
var o_so_7 = CreText('o_so_7',226,112,105,45,"",'#0080c0','#ffffff','#ffffff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',2,'#ffffff','#0080c0','0','0','rgba(0,0,0,0)','0','0','4','0',2,2,'#c0c0c0',0,1.50);
...
var o_so_8 = CreText('o_so_8',333,112,105,45,"",'#0080c0','#ffffff','#ffffff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',2,'#ffffff','#0080c0','0','0','rgba(0,0,0,0)','0','0','4','0',2,2,'#c0c0c0',0,1.50);
...
var o_so_9 = CreText('o_so_9',121,248,105,45,"",'#0080c0','#ffffff','#ffffff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',2,'#ffffff','#0080c0','0','0','rgba(0,0,0,0)','0','0','4','0',2,2,'#c0c0c0',0,1.50);
...
var o_so_10 = CreText('o_so_10',16,157,105,45,"",'#0080c0','#ffffff','#ffffff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',2,'#ffffff','#0080c0','0','0','rgba(0,0,0,0)','0','0','4','0',2,2,'#c0c0c0',0,1.50);
...
var o_so_11 = CreText('o_so_11',121,157,105,45,"",'#0080c0','#ffffff','#ffffff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',2,'#ffffff','#0080c0','0','0','rgba(0,0,0,0)','0','0','4','0',2,2,'#c0c0c0',0,1.50);
...
var o_so_12 = CreText('o_so_12',226,157,105,45,"",'#0080c0','#ffffff','#ffffff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',2,'#ffffff','#0080c0','0','0','rgba(0,0,0,0)','0','0','4','0',2,2,'#c0c0c0',0,1.50);
...
var o_so_13 = CreText('o_so_13',333,157,105,45,"",'#0080c0','#ffffff','#ffffff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',2,'#ffffff','#0080c0','0','0','rgba(0,0,0,0)','0','0','4','0',2,2,'#c0c0c0',0,1.50);
...
var o_so_14 = CreText('o_so_14',226,248,105,45,"",'#0080c0','#ffffff','#ffffff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',2,'#ffffff','#0080c0','0','0','rgba(0,0,0,0)','0','0','4','0',2,2,'#c0c0c0',0,1.50);
...
var o_so_15 = CreText('o_so_15',16,202,105,45,"",'#0080c0','#ffffff','#ffffff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',2,'#ffffff','#0080c0','0','0','rgba(0,0,0,0)','0','0','4','0',2,2,'#c0c0c0',0,1.50);
...
var o_so_16 = CreText('o_so_16',121,202,105,45,"",'#0080c0','#ffffff','#ffffff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',2,'#ffffff','#0080c0','0','0','rgba(0,0,0,0)','0','0','4','0',2,2,'#c0c0c0',0,1.50);
...
var o_so_17 = CreText('o_so_17',226,202,105,45,"",'#0080c0','#ffffff','#ffffff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',2,'#ffffff','#0080c0','0','0','rgba(0,0,0,0)','0','0','4','0',2,2,'#c0c0c0',0,1.50);
...
var o_so_18 = CreText('o_so_18',333,202,105,45,"",'#0080c0','#ffffff','#ffffff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',2,'#ffffff','#0080c0','0','0','rgba(0,0,0,0)','0','0','4','0',2,2,'#c0c0c0',0,1.50);
...
var o_so_19 = CreText('o_so_19',333,248,105,45,"",'#0080c0','#ffffff','#ffffff','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',2,'#ffffff','#0080c0','0','0','rgba(0,0,0,0)','0','0','4','0',2,2,'#c0c0c0',0,1.50);
...
var m_diem = CreText('m_diem',120,110,201,101,"",'rgba(236,217,255,1.11)','#ffffff','#ff0000','#ffffff','',28,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#ffffff','rgba(236,217,255,1.11)','0','0','#ffffff','0','0','4','1',0,0,'rgba(0,0,0,0)',0,1.50);
var bt_lam_lai = CreText('bt_lam_lai',192,191,65,18,"Bắt Đầu",'#ae0000','#ffffff','#ffffff','#ffffff','',10,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#ffffff','#510000','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var t_mess = CreText('t_mess',120,111,200,16,"Bài 1",'rgba(64,0,128,1.11)','#ffffff','#ffffff','#ffffff','',12,'Arial','Normal','left','middle',0,'0.00','0','0',1,'#ffffff','rgba(128,0,255,1.11)','4','1','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var label = CreText('label',124,116,193,74,"Bạn chọn liên tiếp các ô có giá trị tăng dần.",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',11,'Arial','Normal','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var phut = CreText('phut',318,19,38,24,"0",'rgba(0,0,0,0)','#ffffff','#ffffff','#ffffff','',18,'Arial','Normal','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var giay = CreText('giay',360,19,38,24,"0",'rgba(0,0,0,0)','#ffffff','#ffffff','#ffffff','',18,'Arial','Normal','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var Text_8 = CreText('Text_8',407,12,30,30,"››",'#aa7c41','#ffffff','#ffffff','#ffff00','',20,'Arial','Bold','center','middle',2,'0.00','0','0',3,'#ffffff','#aa7c41','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var Text_1 = CreText('Text_1',394,39,14,26,"|",'#d9aa7f','#ffffff','rgba(0,0,0,0)','#ffffff','',48,'Arial','Normal','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#d9aa7f','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var Text_7 = CreText('Text_7',27,40,13,26,"|",'#d9aa7f','#ffffff','rgba(0,0,0,0)','#ffffff','',48,'Arial','Normal','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#d9aa7f','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var bang_diem = new Kinetic.Group({name:'bang_diem',x:0,y:0,width:205,height:105});
bang_diem.add(m_diem,label,t_mess,bt_lam_lai);
Page_1.add(Page_1_Backrounnd,Text_3,Text_2,obj_view,Text_6,o_so_0,o_so_1,o_so_2,o_so_3,o_so_4,o_so_5,o_so_6,o_so_7,o_so_8,o_so_9,o_so_10,o_so_11,o_so_12,o_so_13,o_so_14,o_so_15,o_so_16,o_so_17,o_so_18,o_so_19,phut,giay,Text_8,Text_1,Text_7,bang_diem);
stage.add(Page_1);

 var Page_2 = new Kinetic.Layer({name: 'Page_2',callback:'Page_2()'});
var Page_2_Backrounnd = CreText('Page_2_Backrounnd',0,0,450,350,'','#8000ff','','','','ID_IMAGE2.PNG',12,'Times New Roman','','left','center',0,'0.00','0',0,'0',0,'#8000ff','2','2','0','','0','0','0','0',0,0,'');
...
var o_0 = CreText('o_0',64,53,36,33,"Một hình tam giác có độ dài mỗi cạnh đều bằng 8cm. Tính chu vi hình tam giác đó?|24",'rgba(0,0,0,0)','#ffffff','rgba(0,0,0,0)','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var o_1 = CreText('o_1',102,53,36,33,"Một hình tam giác có độ dài mỗi cạnh đều bằng 8cm. Tính chu vi hình tam giác đó?|24",'rgba(0,0,0,0)','#ffffff','rgba(0,0,0,0)','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var o_2 = CreText('o_2',140,53,36,33,"Một hình tam giác có độ dài mỗi cạnh đều bằng 8cm. Tính chu vi hình tam giác đó?|24",'#ff0000','#ffffff','rgba(0,0,0,0)','#ffffff','ID_CAU_HOI.PNG',36,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ff0000','2','0','rgba(0,0,0,0)','0','0','4','0',0,0, 'rgba(0,0,0,0)',0,1.50);
...
var o_3 = CreText('o_3',178,53,36,33,"Trường An Bình có tất cả 985 học sinh, Trường Kim Liên có ít hơn trường An Bình 85 học sinh. Tính số học sinh Trường Lim Liên.|900",'rgba(0,0,0,0)','#ffffff','rgba(0,0,0,0)','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var o_4 = CreText('o_4',216,53,36,33,"Trường An Bình có tất cả 985 học sinh, Trường Kim Liên có ít hơn trường An Bình 85 học sinh. Tính số học sinh Trường Lim Liên.|900",'rgba(0,0,0,0)','#ffffff','rgba(0,0,0,0)','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var o_5 = CreText('o_5',254,53,36,33,"Trường An Bình có tất cả 985 học sinh, Trường Kim Liên có ít hơn trường An Bình 85 học sinh. Tính số học sinh Trường Lim Liên.|900",'#ff0000','#ffffff','rgba(0,0,0,0)','#ffffff','ID_CAU_HOI.PNG',36,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ff0000','2','0','rgba(0,0,0,0)','0','0','4','0',0,0, 'rgba(0,0,0,0)',0,1.50);
...
var o_7 = CreText('o_7',330,53,36,33,"Đem chia bao gạo nặng 45kg  vào các túi nhỏ như nhau mỗi túi 5kg. Hỏi số túi gạo chia được là bao nhiêu túi?|9",'rgba(0,0,0,0)','#ffffff','rgba(0,0,0,0)','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var o_8 = CreText('o_8',64,88,36,33,"Đem chia bao gạo nặng 45kg  vào các túi nhỏ như nhau mỗi túi 5kg. Hỏi số túi gạo chia được là bao nhiêu túi?|9",'rgba(0,0,0,0)','#ffffff','rgba(0,0,0,0)','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var o_9 = CreText('o_9',102,88,36,33,"Đem chia bao gạo nặng 45kg  vào các túi nhỏ như nhau mỗi túi 5kg. Hỏi số túi gạo chia được là bao nhiêu túi?|9",'#ff0000','#ffffff','rgba(0,0,0,0)','#ffffff','ID_CAU_HOI.PNG',36,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ff0000','2','0','rgba(0,0,0,0)','0','0','4','0',0,0, 'rgba(0,0,0,0)',0,1.50);
...
var o_15 = CreText('o_15',330,88,36,33,"Số nào đem nhân với 5 rồi trừ đi 3 thì được là 32?|7",'#ff0000','#ffffff','rgba(0,0,0,0)','#ffffff','ID_CAU_HOI.PNG',36,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ff0000','2','0','rgba(0,0,0,0)','0','0','4','0',0,0, 'rgba(0,0,0,0)',0,1.50);
...
var o_16 = CreText('o_16',64,123,36,33,"Số nào đem chia cho 5 rồi cộng với 2 thì được 10?|40",'#ff0000','#ffffff','rgba(0,0,0,0)','#ffffff','ID_CAU_HOI.PNG',36,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ff0000','2','0','rgba(0,0,0,0)','0','0','4','0',0,0, 'rgba(0,0,0,0)',0,1.50);
...
var o_19 = CreText('o_19',178,123,36,33,"Số nào đem chia cho 3 rồi nhân với 4 thì được 40?|30",'#ff0000','#ffffff','rgba(0,0,0,0)','#ffffff','ID_CAU_HOI.PNG',36,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ff0000','2','0','rgba(0,0,0,0)','0','0','4','0',0,0, 'rgba(0,0,0,0)',0,1.50);
...
var o_20 = CreText('o_20',216,123,36,33,"Hãy cho biết số nhỏ nhất có 3 chữ số là số nào?100",'rgba(0,0,0,0)','#ffffff','rgba(0,0,0,0)','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var o_21 = CreText('o_21',254,123,36,33,"Hãy cho biết số nhỏ nhất có 3 chữ số là số nào?100",'#ff0000','#ffffff','rgba(0,0,0,0)','#ffffff','ID_CAU_HOI.PNG',36,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ff0000','2','0','rgba(0,0,0,0)','0','0','4','0',0,0, 'rgba(0,0,0,0)',0,1.50);
...
var o_32 = CreText('o_32',64,193,36,33,"Tìm số lớn nhất có 3 chữ số mà tổng các chữ số của số đó bằng 16?|970",'#ffffff','#ffffff','rgba(0,0,0,0)','#ffffff','ID_CAU_HOI.PNG',16,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ffffff','2','2','rgba(0,0,0,0)','0','0','4','0',0,0, 'rgba(0,0,0,0)',0,1.50);
...
var o_33 = CreText('o_33',102,193,36,33,"Tìm số lớn nhất có 3 chữ số mà tổng các chữ số của số đó bằng 16?|970",'rgba(0,0,0,0)','#ffffff','rgba(0,0,0,0)','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var o_34 = CreText('o_34',140,193,36,33,"Tìm số lớn nhất có 3 chữ số mà tổng các chữ số của số đó bằng 16?|970",'rgba(0,0,0,0)','#ffffff','rgba(0,0,0,0)','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var o_35 = CreText('o_35',178,193,36,33,"Tìm số lớn nhất có 3 chữ số mà tổng các chữ số của số đó bằng 16?|970",'#ffffff','#ffffff','rgba(0,0,0,0)','#ffffff','ID_CAU_HOI.PNG',16,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ffffff','2','0','rgba(0,0,0,0)','0','0','4','0',0,0, 'rgba(0,0,0,0)',0,1.50);
...
var o_36 = CreText('o_36',216,193,36,33,"Tìm số lớn nhất có 3 chữ số mà tổng các chữ số của số đó bằng 16?|970",'rgba(0,0,0,0)','#ffffff','rgba(0,0,0,0)','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var o_37 = CreText('o_37',254,193,36,33,"Tìm số lớn nhất có 3 chữ số mà tổng các chữ số của số đó bằng 16?|970",'#ffffff','#ffffff','rgba(0,0,0,0)','#ffffff','ID_CAU_HOI.PNG',16,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ffffff','2','2','rgba(0,0,0,0)','0','0','4','0',0,0, 'rgba(0,0,0,0)',0,1.50);
...
var o_38 = CreText('o_38',292,193,36,33,"Tìm số lớn nhất có 3 chữ số mà tổng các chữ số của số đó bằng 16?|970",'rgba(0,0,0,0)','#ffffff','rgba(0,0,0,0)','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var o_48 = CreText('o_48',64,263,36,33,"Tìm số nhỏ nhất có 3 chữ số mà tổng các chữ số của số đó bằng 12?|129",'#ffffff','#ffffff','rgba(0,0,0,0)','#ffffff','ID_CAU_HOI.PNG',16,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ffffff','2','2','rgba(0,0,0,0)','0','0','4','0',0,0, 'rgba(0,0,0,0)',0,1.50);
...
var o_49 = CreText('o_49',102,263,36,33,"Cho biết thứ 6 tuần này là ngày 21. Hỏi thứ 5 tuần trước là ngày bao nhiêu?13",'rgba(0,0,0,0)','#ffffff','rgba(0,0,0,0)','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var o_50 = CreText('o_50',140,263,36,33,"Cho biết thứ 6 tuần này là ngày 21. Hỏi thứ 5 tuần trước là ngày bao nhiêu?13",'rgba(0,0,0,0)','#ffffff','rgba(0,0,0,0)','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var o_51 = CreText('o_51',178,263,36,33,"Cho biết thứ 6 tuần này là ngày 21. Hỏi thứ 5 tuần trước là ngày bao nhiêu?13",'#ffffff','#ffffff','rgba(0,0,0,0)','#ffffff','ID_CAU_HOI.PNG',16,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ffffff','2','2','rgba(0,0,0,0)','0','0','4','0',0,0, 'rgba(0,0,0,0)',0,1.50);
...
var o_56 = CreText('o_56',64,298,36,33,"Hiện nay anh 24 tuổi, em 15 tuổi.Tính tổng số tuổi của hai anh em khi tuổi em bằng tuổi anh hiện nay?|57",'rgba(0,0,0,0)','#ffffff','rgba(0,0,0,0)','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var o_57 = CreText('o_57',102,298,36,33,"Hiện nay anh 24 tuổi, em 15 tuổi.Tính tổng số tuổi của hai anh em khi tuổi em bằng tuổi anh hiện nay?|57",'#ffffff','#ffffff','rgba(0,0,0,0)','#ffffff','ID_STOP.PNG',16,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ffffff','2','0','rgba(0,0,0,0)','0','0','4','0',0,0, 'rgba(0,0,0,0)',0,1.50);
...
var o_58 = CreText('o_58',140,298,36,33,"Hiện nay anh 24 tuổi, em 15 tuổi.Tính tổng số tuổi của hai anh em khi tuổi em bằng tuổi anh hiện nay?|57",'rgba(0,0,0,0)','#ffffff','rgba(0,0,0,0)','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var o_59 = CreText('o_59',178,298,36,33,"Hiện nay anh 24 tuổi, em 15 tuổi.Tính tổng số tuổi của hai anh em khi tuổi em bằng tuổi anh hiện nay?|57",'#ffffff','#ffffff','rgba(0,0,0,0)','#ffffff','ID_STOP.PNG',16,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ffffff','2','0','rgba(0,0,0,0)','0','0','4','0',0,0, 'rgba(0,0,0,0)',0,1.50);
...
var o_60 = CreText('o_60',216,298,36,33,"Hiện nay anh 24 tuổi, em 15 tuổi.Tính tổng số tuổi của hai anh em khi tuổi em bằng tuổi anh hiện nay?|57",'rgba(0,0,0,0)','#ffffff','rgba(0,0,0,0)','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var o_61 = CreText('o_61',254,298,36,33,"Hiện nay anh 24 tuổi, em 15 tuổi.Tính tổng số tuổi của hai anh em khi tuổi em bằng tuổi anh hiện nay?|57",'#ffffff','#ffffff','rgba(0,0,0,0)','#ffffff','ID_CAU_HOI.PNG',16,'Arial','Normal','center','middle',3,'0.00','0','0',1,'#804000','#ffffff','2','0','rgba(0,0,0,0)','0','0','4','0',0,0, 'rgba(0,0,0,0)',0,1.50);
...
var cau_hoi = CreText('cau_hoi',35,134,364,90,"Số viên bi của Minh bằng 1/2 số viên bi của Tùng. Nếu Tùng cho Minh 4 viên bi thì số bi của hai bạn bằng nhau. Hỏi Tùng có bao nhiêu viên bi?|16",'#8000ff','#ffffff','#ffffff','#ffffff','',10,'Arial','Normal','center','middle',0,'0.00','0','0',2,'#ffffff','#400080','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var m_kq = CreText('m_kq',278,203,64,18,"642",'#ffffff','#ffffff','#0000ff','#ffffff','',14,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#666666','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var bt_ok = CreText('bt_ok',348,203,48,18,"OK",'#400080','#ffffff','#ffff00','#ffffff','',12,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#ffffff','#8000ff','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var title = CreText('title',35,134,364,18,"CÂU HỎI",'#400080','#ffffff','#ffff00','#ffffff','',12,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#ffffff','#8000ff','4','1','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var close_msg = CreText('close_msg',382,134,17,18,"x",'#400080','#ffffff','#ffffff','#ffffff','',10,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#ffffff','#8000ff','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
