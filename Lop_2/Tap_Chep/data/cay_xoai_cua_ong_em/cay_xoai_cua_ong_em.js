folder_Resource ='data/cay_xoai_cua_ong_em';
var doan_van="";
var cau_van="";
var Startdot= 0;
var Enddot= 0;
...
var content = CreText('content',31,32,454,92,"     Ông em trồng cây xoài cát này trước sân khi em còn đi lẫm chẫm. Cuối đông, hoa nở trắng cành. Đầu hè, quả sai lúc lỉu.Trông từng chùm quả to, đu đưa theo gió, em càng nhớ ông. Mùa xoài nào, mẹ em cũng chọn những quả chín vàng và to nhất bày lên bàn thờ ông.",'rgba(0,0,0,0)','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
