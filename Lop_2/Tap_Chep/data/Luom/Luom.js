...
var content = CreText('content',38,41,206,199,"Chú bé loắt choắt, \r\nCái xắc xinh xinh, \r\nCái chân thoăn thoắt, \r\nCái đầu nghênh nghênh. \r\n\r\nCa-lô đội lệch,\r\nMồm huýt sáo vang,\r\nNhư con chim chích,\r\nNhảy trên đường vàng…\r\n\r\n",'rgba(0,0,0,0)','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.50);
var Text_3 = CreText('Text_3',244,250,144,24,"Nghe viết chính tả",'#ffff00','#ffffff','#000000','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','5','0',0,'rgba(0,0,0,0)','#ffff00','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var title = CreText('title',36,14,210,25,"LƯỢM\r\n",'rgba(0,0,0,0)','#ffffff','#ffff00','#ffffff','',16,'Arial','Bold','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var Text_1 = CreText('Text_1',126,250,106,24,"Nghe cả bài",'#ffff00','#ffffff','#000000','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','5','0',0,'rgba(0,0,0,0)','#ffff00','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var txt_input = CreText('txt_input',251,54,206,192,"",'#004040','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',1,'#c0c0c0','#004040','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.50);
...
var txtDiem = CreText('txtDiem',401,250,69,24,"Điểm",'#ffff00','#ffffff','#000000','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','5','0',0,'rgba(0,0,0,0)','#ffff00','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var wrong_word = CreText('wrong_word',126,82,306,133,"",'#ffffb0','#ffffff','#ff0000','#ffffff','',10,'Arial','Normal','center','middle',3,'0.00','5','0',1,'#ffffff','#ffffb0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var ww_title = CreText('ww_title',126,64,306,22,"Bạn sai các từ sau:",'#ffad5b','#ffffff','#000000','#ffffff','',14,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#666666','#ffad5b','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var btClose = CreText('btClose',395,64,37,22,"X",'#c0c0c0','#ffffff','#282828','#ffffff','',16,'Arial','Bold','center','middle',3,'0.00','5','0',1,'#666666','#ffffff','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var m_diem = CreText('m_diem',343,154,87,61,"",'rgba(0,0,0,0)','#ffffff','#ff0000','#ffffff','',48,'Arial','Normal','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
