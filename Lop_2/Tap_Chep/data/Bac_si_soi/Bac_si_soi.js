folder_Resource ='data/Bac_si_soi';
var doan_van="";
var cau_van="";
var Startdot= 0;
var Enddot= 0;
...
var content = CreText('content',31,32,454,106,"     Muốn ăn thịt Ngựa, Sói giả làm bác sĩ, đến gần Ngựa, bảo: “Có bệnh, ta chữa giúp cho”. Ngựa biết mưu của Sói, vờ nhờ Sói khám giúp chân sau. Sói định cắn vào chân cho Ngựa hết chạy, nhưng Ngựa đã kịp thời tung vó, đá cho Sói một cú trời giáng.\r\n",'rgba(0,0,0,0)','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.50);
