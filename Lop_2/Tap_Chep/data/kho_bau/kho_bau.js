...
var content = CreText('content',30,28,452,90,"       Ngày xưa, có hai vợ chồng người nông dân kia quanh năm hai sương một nắng, cuốc bẫm cày sâu. Hai ông bà thường ra đồng từ lúc gà gáy sáng và trở về nhà khi đã lặn mặt trời. Đến vụ lúa, họ cấy lúa, gặt hái xong, lại trồng khoai, trồng cà.",'rgba(0,0,0,0)','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.50);
var Text_3 = CreText('Text_3',264,268,144,24,"Nghe viết chính tả",'#ffff00','#ffffff','#000000','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','5','0',0,'rgba(0,0,0,0)','#ffff00','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var title = CreText('title',51,5,409,25,"Kho báu\r\n",'rgba(0,0,0,0)','#ffffff','#ffff00','#ffffff','',16,'Arial','Bold','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var Text_1 = CreText('Text_1',147,268,106,24,"Nghe cả bài",'#ffff00','#ffffff','#000000','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','5','0',0,'rgba(0,0,0,0)','#ffff00','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var txt_input = CreText('txt_input',22,160,450,94,"",'#004040','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',1,'#c0c0c0','#004040','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.50);
var txt_inputTitle = CreText('txt_inputTitle',85,128,323,25,"",'#004040','#ffffff','#ffff00','#ffffff','',16,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#ffffff','#004040','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',2,1.50);
var txtDiem = CreText('txtDiem',421,268,69,24,"Điểm",'#ffff00','#ffffff','#000000','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','5','0',0,'rgba(0,0,0,0)','#ffff00','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
