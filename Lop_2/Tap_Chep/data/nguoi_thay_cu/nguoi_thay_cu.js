folder_Resource ='data/nguoi_thay_cu';
var doan_van="";
var cau_van="";
var Startdot= 0;
var Enddot= 0;
...
var content = CreText('content',31,32,445,83,"Dũng xúc động nhìn theo bố đang đi ra phía cổng trường rồi lại nhìn cái khung cửa sổ lớp học. Em nghĩ: bố cũng có lần mắc lỗi, thầy không phạt, nhưng bố nhận đó là hình phạt và nhớ mãi. Nhớ để không bao giờ mắc lại nữa.\r\n",'rgba(0,0,0,0)','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var txt_input = CreText('txt_input',31,141,450,97,"",'#004040','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',1,'#c0c0c0','#004040','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',5,1.50);
