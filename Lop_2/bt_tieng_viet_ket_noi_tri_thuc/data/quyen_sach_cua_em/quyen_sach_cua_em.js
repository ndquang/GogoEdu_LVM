folder_Resource = '/data/quyen_sach_cua_em';
var m_color = "";
var obj_down = "";
var obj_up = "";
var _score = 0;
...
var array_a = ["✔", "", "", "", "", "", "✔"];
//
var array_input = ["Tên sách được đặt ở bìa sách", "Tên tác giả đặt ở bìa sách", "Xương rồng", "Thông", "Đước", "25", "Chúng tớ được sinh ra và lớn lên như thế nào?", "Trần Diệu Linh", "Giáo dục Việt Nam"];
...
window.onload = function () {
	...
	var y_y = CreText('y_y', 352, 372, 225, 100, "Từ ngữ chỉ hoạt động", 'rgba(0,0,0,0)', '#ffffff', '#0080ff', '#0080ff', '', 20, 'Arial', 'Normal', 'center', 'middle', 3, '0.00', '3', '75', 1, '#0080ff', '#ffffff', '0', '0', 'rgba(0,0,0,0)', '0', '0', '4', '0', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	var x_x = CreText('x_x', 93, 373, 237, 98, "Từ ngữ chỉ người, chỉ vật", 'rgba(0,0,0,0)', '#ffffff', '#0080ff', '#0080ff', '', 20, 'Arial', 'Normal', 'center', 'middle', 3, '0.00', '3', '75', 1, '#0080ff', '#ffffff', '0', '0', 'rgba(0,0,0,0)', '0', '0', '4', '0', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	...
	var Text_16 = CreText('Text_16', 439, 751, 52, 26, "", 'rgba(0,0,0,0)', '#ffffff', '#000000', '#ffffff', '', 14, 'Arial', 'Normal', 'left', 'middle', 0, '0.00', '0', '0', 1, '#c0c0c0', 'rgba(230,230,250,0.89)', '0', '0', 'rgba(0,0,0,0)', '0', '0', '4', '0', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	...
	var input_5 = CreText('input_5', 175, 834, 293, 45, "a. Tên sách được đặt ở ...", 'rgba(0,0,0,0)', '#ffffff', '#000000', '#ffffff', '', 14, 'Arial', 'Normal', 'left', 'top', 0, '0.00', '0', '0', 1, '#c0c0c0', 'rgba(230,230,250,0.89)', '0', '0', 'rgba(0,0,0,0)', '0', '0', '4', '0', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	var input_6 = CreText('input_6', 175, 893, 293, 26, "a. Tên sách được đặt ở ...", 'rgba(0,0,0,0)', '#ffffff', '#000000', '#ffffff', '', 14, 'Arial', 'Normal', 'left', 'middle', 0, '0.00', '0', '0', 1, '#c0c0c0', 'rgba(230,230,250,0.89)', '0', '0', 'rgba(0,0,0,0)', '0', '0', '4', '0', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	var input_7 = CreText('input_7', 174, 934, 293, 26, "a. Tên sách được đặt ở ...", 'rgba(0,0,0,0)', '#ffffff', '#000000', '#ffffff', '', 14, 'Arial', 'Normal', 'left', 'middle', 0, '0.00', '0', '0', 1, '#c0c0c0', 'rgba(230,230,250,0.89)', '0', '0', 'rgba(0,0,0,0)', '0', '0', '4', '0', 0, 0, 'rgba(0,0,0,0)', 0, 1.50);
	Page_1.add(Page_1_Backrounnd, Image_3, Text_11, Text_28, Text_29, a_0, c_2, msg, diem, Image_1, Text_3, Text_5, b_1, c_c, a_a, b_b, Image_2, Text_4, input_0, Text_2, Text_6, d_3, d_d, obj_paint, abc_6, y_y, x_x, Text_1, Text_7, y_3, y_4, x_0, x_2, x_1, input_1, Text_9, Text_10, input_3, input_2, input_4, Text_15, Text_16, Text_17, Text_18, Image_4, Text_19, Text_20, Text_21, input_5, input_6, input_7);
	stage.add(Page_1);
	InitLacVietScript();
};
