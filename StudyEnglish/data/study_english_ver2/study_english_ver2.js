folder_Resource ='/data/study_english_ver2';
var bReading = false;
var bWriting = false;
...
var recognizer = new SpeechRecognizer({ lang: "en-US",  timeout: 12000});
...
var vn_2 = CreText('vn_2',79,265,406,43,"",'rgba(0,0,0,0)','#ffffff','#c0c0c0','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var vn_1 = CreText('vn_1',78,176,407,35,"",'rgba(0,0,0,0)','#ffffff','#c0c0c0','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var check_1 = CreText('check_1',10,122,70,49,"Ami",'rgba(0,0,0,0)','#ffffff','#00c8c8','#ffffff','',18,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#00c8c8','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var check_2 = CreText('check_2',10,214,70,49,"Ben",'rgba(0,0,0,0)','#ffffff','#00c8c8','#ffffff','',18,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#00c8c8','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var title = CreText('title',114,1,384,54,"Hello",'#ffffff','#ffffff','#ff6820','#ffffff','',24,'Segoe UI Black','Bold','center','middle',0,'0.00','0','0',2,'#00c8c8','#ffffff','0','0','#7f7f7f','0','0','4','1',0,0,'rgba(0,0,0,0)',0,1.50);
...
var unit = CreText('unit',1,1,112,54,"Daily Life",'#00c8c8','#ffffff','#ffffff','#ffffff','',18,'SimSun','Bold','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#00c8c8','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var score = CreText('score',142,311,275,28,"",'#ffffff','#ffffff','#00c8c8','#ffffff','',12,'Arial','Bold','center','middle',12,'0.00','2','2',1,'#00c8c8','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var bt_next = CreText('bt_next',358,311,27,28,"▶",'rgba(0,0,0,0)','#ffffff','#00c8c8','#00c8c8','',16,'Arial','Normal','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','#000000','0','0','4','1',0,0,'rgba(0,0,0,0)',0,1.50);
...
var bt_pre = CreText('bt_pre',161,311,27,28,"◀",'rgba(0,0,0,0)','#ffffff','#00c8c8','#00c8c8','',16,'Arial','Normal','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','#282828','0','0','4','1',0,0,'rgba(0,0,0,0)',0,1.50);
...
var btPlay = CreText('btPlay',65,305,41,41,"🎧",'#ffffff','#ffffff','#e6e6fa','#ffffff','',16,'Arial','Normal','center','middle',2,'0.00','0','0',1,'#00c8c8','#ffffff','0','0','#282828','0','0','4','1',0,0,'rgba(0,0,0,0)',0,1.50);
...
var en_1 = CreText('en_1',80,122,405,49,"characters 1",'#ffffff','#ffffff','#000000','#ffffff','',16,'Arial','Normal','left','middle',0,'0.00','0','0',1,'#00c8c8','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var en_2 = CreText('en_2',79,214,406,49,"characters 2",'#ffffff','#ffffff','#000000','#ffffff','',16,'Arial','Normal','left','middle',0,'0.00','0','0',1,'#00c8c8','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
Page_1.add(Page_1_Backrounnd,vn_2,vn_1,sliderRect,_3,_2,_1,btSlide,check_1,check_2,title,unit,msg,score,bt_next,bt_pre,btPlay,total_score,en_1,en_2);
stage.add(Page_1);
InitLacVietScript();
};
