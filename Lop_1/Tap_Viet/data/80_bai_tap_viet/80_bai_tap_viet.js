folder_Resource ='data/80_bai_tap_viet';
var dem= 0;
var maxBai = 83;
function OnClickTV()
{
...
function Page_6()
{
createFlashMarkup('Flash_2', 191, 20, 432 , 167 ,'ID_FLASH_Bai_12.swf','Page 6');
...
var p_l = CreText('p_l',4,5,164,469,"gamechocon.com",'#cfe3ff','#ffffff','#000000','#ffffff','ID_IMAGE17.JPG',10,'Verdana','Normal','center','bottom',0,'0.00','0','0',0,'rgba(0,0,0,0)','#cfe3ff','2','2','rgba(0,0,0,0)','0','0','4','1',0,0, 'rgba(0,0,0,0)',0,1.50);
var print = CreText('print',179,6,455,469,"\r\n\r\nhttps://gamechocon.com\r\n",'rgba(0,0,0,0)','#ff0000','#c0c0c0','#ffffff','',12,'Verdana','Normal','center','top',0,'0.00','0','0',2,'#ff6820','#ff0000','0','0','rgba(0,0,0,0)','1','1','4','1',1,1,'rgba(0,0,0,0)',0,1.50);
...
var select = CreText('select',9,22,156,25,"Chọn bài viết",'rgba(0,0,0,0)','#ffffff','#ff00ff','#ffffff','',18,'Verdana','Bold','center','middle',0,'0.00','32','32',0,'rgba(0,0,0,0)','rgba(0,85,0,0.73)','0','0','rgba(0,0,0,0)','1','1','4','1',1,0,'rgba(0,0,0,0)',0,1.50);
select.on('mouseup touchend dragend',function(evt)/*---dragend---*/
{
m_pgObjCaller = this;
...
var title = CreText('title',206,84,79,58,"Bài 1",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',18,'Arial','Bold','center','middle',0,'0.00','0','0',2,'#ffa6d2','#ffff9d','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var Text_11 = CreText('Text_11',300,75,253,80,"Trường    :\r\nLớp          :\r\nHọ và tên :",'rgba(0,0,0,0)','#ffffff','#0000ff','#ffffff','',16,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#c0c0c0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.70);
Page_6.add(Page6_Backrounnd,p_l,print,Image_2,select,Text_1,Text_2,Text_3,Text_4,Text_5,Text_6,Text_7,Text_8,Text_9,Text_10,next,pre,Image_1,Text_bai,title,Text_11);
stage.add(Page_6);
InitLacVietScript();
};
