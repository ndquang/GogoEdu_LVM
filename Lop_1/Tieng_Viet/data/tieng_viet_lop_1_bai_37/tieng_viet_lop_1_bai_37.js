folder_Resource ='data/tieng_viet_lop_1_bai_37';
var akq="";
function CheckInput(){
   	for(var i=0;i<=7;i++)
	{
...
function Init()
{
akq = "ây|oi|ôi|ơi|ui|ưi|uôi|ươi".split("|");
for(var i=0;i<=11;i++){
...
Page_1.add(Text_10);
var Image_2 = CreText('Image_2',427,6,392,546,'','rgba(0, 0, 0, 0)','','','','ID_3.JPG',0,'','','','',0,'0.00','0','0',1,'rgba(0, 0, 0, 0)','','2','2','','0','0','4','0',0,0, '#808080');
Page_1.add(Image_2);
...
Page_1.add(lam_lai);
var Image_1 = CreText('Image_1',135,56,159,112,'','rgba(0, 0, 0, 0)','','','','ID_1.JPG',0,'','','','',0,'0.00','0','0',1,'rgba(0, 0, 0, 0)','','2','2','','0','0','4','0',0,0, '#808080');
Page_1.add(Image_1);
var Text_1 = CreText('Text_1',10,0,108,55,"BÀI 37",'#ffd5aa','#ffffff','#000000','#ffffff','',24,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#0080ff','#ffd5aa','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
Page_1.add(Text_1);
...
Page_1.add(tb_2);
var Text_4 = CreText('Text_4',78,85,48,34,"i",'#ffffff','#ffffff','#000000','#ffffff','',24,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#f000f0','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(tb_0);
var Text_33 = CreText('Text_33',190,165,47,27,"i",'#ffffff','#ffffff','#ff00ff','#ffffff','',16,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#ff00ff','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(Text_33);
var Text_34 = CreText('Text_34',238,165,47,27,"y",'#ffffff','#ffffff','#ff00ff','#ffffff','',16,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#ff00ff','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(Text_34);
var Text_6 = CreText('Text_6',152,219,37,27,"â",'#ffffff','#ffffff','#0080ff','#ffffff','',14,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#ff00ff','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(Text_6);
var Text_38 = CreText('Text_38',152,246,37,27,"o",'#ffffff','#ffffff','#0080ff','#ffffff','',14,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#ff00ff','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(Text_42);
var Text_5 = CreText('Text_5',100,463,84,24,"đôi đũa",'rgba(0, 0, 0, 0)','#ffffff','#0000ff','#ffffff','',16,'Arial','Bold','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(Text_5);
var Text_7 = CreText('Text_7',190,463,83,24,"tuổi thơ",'rgba(0, 0, 0, 0)','#ffffff','#0000ff','#ffffff','',16,'Arial','Bold','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(kiem_tra);
var Text_11 = CreText('Text_11',280,463,93,24,"mây bay",'rgba(0, 0, 0, 0)','#ffffff','#0000ff','#ffffff','',16,'Arial','Bold','left','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(Text_2);
var Text_8 = CreText('Text_8',565,299,151,34,"Cây khế",'#ffffff','#ffffff','#000000','#ffffff','',20,'Arial','Normal','center','middle',0,'0.00','0','0',0,'rgba(0, 0, 0, 0)','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(Image_3);
var Image_4 = CreText('Image_4',76,503,237,53,'','rgba(0, 0, 0, 0)','','','','ID_2.JPG',0,'','','','',0,'0.00','0','0',1,'rgba(0, 0, 0, 0)','','2','2','','0','0','4','0',0,0, '#808080');
Page_1.add(Image_4);
var Image_5 = CreText('Image_5',27,489,30,32,'','rgba(0, 0, 0, 0)','','','','ID_IMAGE5.JPG',0,'','','','',0,'0.00','0','0',1,'rgba(0, 0, 0, 0)','','2','2','','0','0','4','0',0,0, '#808080');
Page_1.add(Image_5);
var Text_3 = CreText('Text_3',32,85,94,69,"ai",'rgba(0, 0, 0, 0)','#ffffff','#000000','#ffffff','',24,'Arial','Bold','center','bottom',0,'0.00','0','0',1,'#f000f0','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(Text_16);
var Text_18 = CreText('Text_18',342,85,48,34,"y",'#ffffff','#ffffff','#000000','#ffffff','',24,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#f000f0','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(Text_18);
var Text_20 = CreText('Text_20',296,85,94,69,"ay",'rgba(0, 0, 0, 0)','#ffffff','#000000','#ffffff','',24,'Arial','Bold','center','bottom',0,'0.00','0','0',1,'#f000f0','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(tb_7);
var Text_25 = CreText('Text_25',190,192,47,27,"ai",'#ffffff','#ffffff','#000000','#ffffff','',16,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#ff00ff','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(Text_26);
var Text_27 = CreText('Text_27',152,300,37,27,"ơ",'#ffffff','#ffffff','#0080ff','#ffffff','',14,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#ff00ff','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(Text_27);
var Text_28 = CreText('Text_28',152,327,37,27,"u",'#ffffff','#ffffff','#0080ff','#ffffff','',14,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#ff00ff','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(Text_28);
var Text_29 = CreText('Text_29',152,273,37,27,"ô",'#ffffff','#ffffff','#0080ff','#ffffff','',14,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#ff00ff','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(Text_29);
var Text_30 = CreText('Text_30',152,381,37,27,"uô",'#ffffff','#ffffff','#0080ff','#ffffff','',14,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#ff00ff','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(Text_31);
var Text_32 = CreText('Text_32',152,354,37,27,"ư",'#ffffff','#ffffff','#0080ff','#ffffff','',14,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#ff00ff','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
...
Page_1.add(Text_32);
var Text_9 = CreText('Text_9',238,192,47,27,"ay",'#ffffff','#ffffff','#000000','#ffffff','',16,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#ff00ff','#ffffff','0','0','rgba(0, 0, 0, 0)','0','0','4','0',0,0,'rgba(0, 0, 0, 0)',0,1.50);
