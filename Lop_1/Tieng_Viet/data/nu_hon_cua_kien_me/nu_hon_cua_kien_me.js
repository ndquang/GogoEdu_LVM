folder_Resource ='data/nu_hon_cua_kien_me'
styteView = 'Ver';
var a_kq=["b","c","c","b"];
var a_tl=[0,0,0,0];
function InitBaiHoc(){
...
var noi_dung = CreText('noi_dung',19,78,621,173,"Kiến Mẹ có một vạn con. Tối nào, Kiến Mẹ cũng vỗ về và thơm yêu từng đứa con :\r\n- Chúc con ngủ ngon ! Mẹ yêu con !\r\nÐể hôn hết đàn con, suốt đêm Kiến Mẹ không chợp mắt.\r\nBác Cú Mèo chỉ cho một kế : đến giờ đi ngủ, hãy thơm những chú kiến con đầu tiên ở mỗi hàng. Sau khi được mẹ thơm, chú kiến này quay sang thơm chú bên cạnh và thầm thì :\r\n- Mẹ gửi một cái hôn cho em đấy !\r\nCứ thế, lần lượt lũ kiến con hôn chuyền nhau. Và Kiến Mẹ có thể chợp mắt mà vẫn âu yếm được cả dàn con.",'rgba(0,0,0,0)','#ffffff','#ffffff','#ffffff','',14,'Arial','Normal','left','top',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.80);
var title = CreText('title',136,38,350,26,"Nụ hôn của Kiến Mẹ",'rgba(0,0,0,0)','#ffffff','#ffff00','#ffffff','',22,'Arial','Bold','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var Image_2 = CreText('Image_2',451,23,47,46,'','rgba(0,0,0,0)','','','','ID_IMAGE3.PNG',0,'','','','',0,'0.00','0','0',1,'rgba(0,0,0,0)','','2','2','','0','0','4','0',0,0, '#808080');
...
var Cau_hoi_0 = CreText('Cau_hoi_0',45,38,473,27,"1. Buổi tối Kiến Mẹ làm gì cho đàn con?",'rgba(0,0,0,0)','#ffffff','#fffe99','#fffe99','',16,'Arial','Bold','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var a_0 = CreText('a_0',80,65,429,22,"a. Ru cho đàn con ngủ.",'rgba(0,0,0,0)','#ffffff','#ffffff','#ffffff','',16,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var b_0 = CreText('b_0',80,88,429,22,"b. Vỗ về và hôn từng đưa con.",'rgba(0,0,0,0)','#ffffff','#ffffff','#ffffff','',16,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var c_0 = CreText('c_0',80,109,429,22,"c. Sắp xếp chỗ ngủ cho đàn con.",'rgba(0,0,0,0)','#ffffff','#ffffff','#ffffff','',16,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var Cau_hoi_1 = CreText('Cau_hoi_1',52,131,574,27,"2. Tại sao suốt đêm Kiến Mẹ không chợp mắt?",'rgba(0,0,0,0)','#ffffff','#fffe99','#fffe99','',16,'Arial','Bold','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var a_1 = CreText('a_1',80,156,429,22,"a. Vì kiến mẹ phải làm lụng vất vả.",'rgba(0,0,0,0)','#ffffff','#ffffff','#ffffff','',16,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var b_1 = CreText('b_1',79,178,429,22,"b. Vì kiến mẹ rất yêu thương kiến con.",'rgba(0,0,0,0)','#ffffff','#ffffff','#ffffff','',16,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var c_1 = CreText('c_1',80,199,429,22,"c. Vì Kiến Mẹ phải hôn hết một vạn kiến con.",'rgba(0,0,0,0)','#ffffff','#ffffff','#ffffff','',16,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var Cau_hoi_2 = CreText('Cau_hoi_2',49,222,592,33,"3. Bác Cú Mèo chỉ cho Kiến Mẹ kế gì?",'rgba(0,0,0,0)','#ffffff','#fffe99','#fffe99','',16,'Arial','Bold','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var a_2 = CreText('a_2',80,255,429,22,"a. Chỉ thơm các chú kiến con đầu mỗi hàng.",'rgba(0,0,0,0)','#ffffff','#ffffff','#ffffff','',16,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var b_2 = CreText('b_2',80,277,429,22,"b. Các chú kiến hôn mẹ.",'rgba(0,0,0,0)','#ffffff','#ffffff','#ffffff','',16,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var c_2 = CreText('c_2',80,298,563,22,"c. Thơm chú kiến đầu mỗi hàng và các chú kiến chuyền nụ hôn của mẹ.",'rgba(0,0,0,0)','#ffffff','#ffffff','#ffffff','',16,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var Cau_hoi_3 = CreText('Cau_hoi_3',53,327,586,27,"4. Dòng nào dưới đây gồm những từ ngữ chỉ tình cảm của Kiến Mẹ.",'rgba(0,0,0,0)','#ffffff','#fffe99','#fffe99','',16,'Arial','Bold','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var a_3 = CreText('a_3',80,355,429,22,"a. Thơm yêu, không ngủ, bày kế.",'rgba(0,0,0,0)','#ffffff','#ffffff','#ffffff','',16,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var b_3 = CreText('b_3',80,377,479,22,"b. Vỗ về, thơm yêu, yêu con, âu yếm.",'rgba(0,0,0,0)','#ffffff','#ffffff','#ffffff','',16,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var c_3 = CreText('c_3',80,398,429,22,"c. Thơm yêu, hôm chuyền nhau, chợp mắt.",'rgba(0,0,0,0)','#ffffff','#ffffff','#ffffff','',16,'Arial','Normal','left','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
