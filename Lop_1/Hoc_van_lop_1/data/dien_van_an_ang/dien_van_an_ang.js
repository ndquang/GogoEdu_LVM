folder_Resource ='data/dien_van_an_ang';
var aX=["hòn than","đàn kiến","buôn bán","cái bàn","công an","san hô","kết bạn","giàn gấc","bạch đàn","thợ hàn","bàn ghế","nhà sàn","chơi đàn","bạn bè","bản đồ","cản trở","hồ dán","đàn kiến","chữ hán","giới hạn","lan can","lán trại","màn hình","thuyền nan","phàn nàn","phản công","quan tâm","đá sạn","tan học","tàn tật","van xin","mạnh dạn"];
var aS=["cây bàng","buôn làng","cái thang","bến cảng","buổi sáng","đình làng","nắng chang","ngày tháng","thẳng hàng","chàng ngốc","càng cua","giang tay","hang động","lạng lách","xàng xê","mạnh dạng","đàng sau","giáng sinh","khăn quàng","sang trọng","tàng hình","màu vàng","chạng vạng","cầu thang"];
function InitCur(){
SetMoveView("","obj_s",1);
SetMoveView("","obj_x",1);
...
var aVan0=["ang","áng","àng","ảng","ãng","ạng"];
var aVan1=["an","án","àn","ản","ãn","ạn"];
var aDau=["...",".´..",".`..",". ̉..",".˜..","..̣."];
function  NewGame()
{
  SetShowObject("","lam_lai",0);
...
var title = CreText('title',17,10,313,38,"1. Điền vần an hay vần ang:",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',20,'Arial','Normal','left','middle',0,'0.00','30','30',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var cham_diem = CreText('cham_diem',245,388,141,33,"CHẤM ĐIỂM",'#80ff00','#ffffff','#000000','#000000','',16,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#ffffff','#c1ff84','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var obj_s = CreText('obj_s',329,48,60,34,"ang",'#ffffe0','#ffffff','#0000ff','#ffffff','',20,'Arial','Normal','center','middle',0,'0.00','30','30',1,'#7f7f7f','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var obj_x = CreText('obj_x',239,49,65,34,"an",'#ffffe0','#ffffff','#0000ff','#ffffff','',20,'Arial','Normal','center','middle',0,'0.00','30','30',1,'#7f7f7f','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var toolTip = CreText('toolTip',664,231,185,40,"ĐIỂM",'#ffffe0','#ffffff','#009300','#ffffff','',20,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#009300','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var lam_lai = CreText('lam_lai',245,388,141,33,"LÀM LẠI",'#80ff00','#ffffff','#000000','#000000','',16,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#ffffff','#c1ff84','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var m_diem = CreText('m_diem',175,197,327,68,"10 điểm",'#ffc0cb','#ffffff','#ff0000','#ffffff','',36,'Comic Sans MS','','center','middle',12,'0.00','4','4',1,'#ff0000','#ffc0cb','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
