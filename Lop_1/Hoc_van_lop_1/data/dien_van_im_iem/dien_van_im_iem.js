folder_Resource ='data/dien_van_im_iem';
var aX=["trốn tìm","xâu kim","màu tím","quả sim","con nhím","tủm tỉm","mũm mĩm","chim câu","bìm bịp","con nhím","ghim giấy","gỗ lim","im lặng","mỉm cười","xem phim","quả tim"];
var aS=["điểm mười","lúa chiêm","thanh kiếm","tìm kiếm","dừa xiêm","quý hiếm","lưỡi liềm","que diêm","kiểm điểm","khiêm tốn","nguy hiểm","lưỡi liềm","niêm phong","kỉ niệm","thiêm thiếp","tiêm chủng","tiềm năng","tiết kiệm","nghiêm cấm","nhiễm trùng","viêm họng"];
function InitCur(){
SetMoveView("","obj_s",1);
SetMoveView("","obj_x",1);
...
var aVan0=["iêm","iếm","iềm","iểm","iễm","iệm"];
var aVan1=["im","ím","ìm","ỉm","ĩm","ịm"];
var aDau=["...",".´..",".`..",". ̉..",".˜..","..̣."];
function  NewGame()
{
  SetShowObject("","lam_lai",0);
...
var title = CreText('title',17,10,313,38,"1. Điền vần im hay vần iêm:",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',20,'Arial','Normal','left','middle',0,'0.00','30','30',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var obj_s = CreText('obj_s',329,48,60,34,"iêm",'#ffffe0','#ffffff','#0000ff','#ffffff','',20,'Arial','Normal','center','middle',0,'0.00','30','30',1,'#7f7f7f','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var obj_x = CreText('obj_x',239,49,65,34,"im",'#ffffe0','#ffffff','#0000ff','#ffffff','',20,'Arial','Normal','center','middle',0,'0.00','30','30',1,'#7f7f7f','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var cham_diem = CreText('cham_diem',485,11,141,31,"CHẤM ĐIỂM",'#80ff00','#ffffff','#000000','#000000','',16,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#ffffff','#c4ff88','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var lam_lai = CreText('lam_lai',486,11,141,31,"LÀM LẠI",'#80ff00','#ffffff','#000000','#000000','',16,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#ffffff','#c4ff88','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var m_diem = CreText('m_diem',217,204,231,65,"10 điểm",'#c4ff88','#ffffff','#ff0000','#ffffff','',36,'Comic Sans MS','','center','middle',12,'0.00','2','2',1,'#ff0000','#c4ff88','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var toolTip = CreText('toolTip',427,425,185,40,"ĐIỂM",'#ffffe0','#ffffff','#009300','#ffffff','',20,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#009300','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
