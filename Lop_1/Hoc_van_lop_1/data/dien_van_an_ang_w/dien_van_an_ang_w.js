folder_Resource ='data/dien_van_an_ang_w';
var aX=["con trăn","ăn cơm","cái khăn","thợ lặn","nặn đồ chơi","bắn súng","dặn dò","căn nhà","cắn câu","ngắn dài","gắn bó","thợ lặn","muối mặn","con rắn"," săn bắn","củ sắn","thằn lằn","bài văn","sẵn sàng"];
var aS=["măng tre","vầng trăng","rặng dừa","phẳng lặng","cố gắng","dấu bằng","căng tin","dăng lưới","đắng cay","găng tay","hăng hái","hằng ngày","lắng nghe","im lặng","năng động","nặng ký","nắng chang chang","quăng lưới","cái răng","tặng quà","vắng mặt"];
function InitCur(){
SetMoveView("","obj_s",1);
SetMoveView("","obj_x",1);
...
var aVan0=["ăng","ắng","ằng","ẳng","ẵng","ặng"];
var aVan1=["ăn","ắn","ằn","ẳn","ẵn","ặn"];
var aDau=["...",".´..",".`..",". ̉..",".˜..","..̣."];
function  NewGame()
{
  SetShowObject("","lam_lai",0);
...
var title = CreText('title',17,10,313,38,"1. Điền vần ăn hay vần ăng:",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',20,'Arial','Normal','left','middle',0,'0.00','30','30',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var obj_s = CreText('obj_s',329,48,60,34,"ăng",'#ffffe0','#ffffff','#0000ff','#ffffff','',20,'Arial','Normal','center','middle',0,'0.00','30','30',1,'#7f7f7f','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var obj_x = CreText('obj_x',239,49,65,34,"ăn",'#ffffe0','#ffffff','#0000ff','#ffffff','',20,'Arial','Normal','center','middle',0,'0.00','30','30',1,'#7f7f7f','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var cham_diem = CreText('cham_diem',264,394,121,28,"Chấm Điểm",'#80ff00','#ffffff','#000000','#000000','',14,'Arial','Bold','center','middle',3,'0.00','0','0',2,'#ffffff','#c1ff84','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var lam_lai = CreText('lam_lai',264,393,121,28,"Làm Lại",'#80ff00','#ffffff','#000000','#000000','',14,'Arial','Bold','center','middle',3,'0.00','0','0',2,'#ffffff','#c1ff84','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var m_diem = CreText('m_diem',177,205,327,68,"10 điểm",'#ffc0cb','#ffffff','#ff0000','#ffffff','',36,'Comic Sans MS','','center','middle',12,'0.00','2','2',1,'#ff0000','#ffc0cb','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var toolTip = CreText('toolTip',663,170,185,40,"ĐIỂM",'#ffffe0','#ffffff','#009300','#ffffff','',20,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#009300','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
