folder_Resource ='data/dien_van_eo_eu';
var aX=["leo trèo","ao bèo","chú mèo","cái kéo","suối đèo","đeo cườm","bánh bèo","lợn béo","băng keo","múa dẻo","eo biển","gieo hạt","heo đất","hẻo lánh","hoa héo","khéo léo","leo cây","méo xẹo","reo vui","vết sẹo","viên kẹo","bánh xèo","teo tóp","đi theo","xui xẻo"];
var aS=["kêu cứu","khăn thêu","cây nêu","kêu gọi","cái phễu","bêu xấu","đều nhau","con nghêu","lêu lêu","cái lều","nêu gương","rong rêu","con sếu"];
function InitCur(){
SetMoveView("","obj_s",1);
SetMoveView("","obj_x",1);
...
var aVan0=["êu","ếu","ều","ểu","ễu","ệu"];
var aVan1=["eo","éo","èo","ẻo","ẽo","ẹo"];
var aDau=["...",".´..",".`..",". ̉..",".˜..","..̣."];
function  NewGame()
{
  SetShowObject("","lam_lai",0);
...
var title = CreText('title',17,10,313,38,"1. Điền vần eo hay vần êu:",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',20,'Arial','Normal','left','middle',0,'0.00','30','30',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var obj_s = CreText('obj_s',329,48,60,34,"êu",'#ffffe0','#ffffff','#0000ff','#ffffff','',20,'Arial','Normal','center','middle',0,'0.00','30','30',1,'#7f7f7f','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var obj_x = CreText('obj_x',239,49,65,34,"eo",'#ffffe0','#ffffff','#0000ff','#ffffff','',20,'Arial','Normal','center','middle',0,'0.00','30','30',1,'#7f7f7f','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var cham_diem = CreText('cham_diem',496,10,121,28,"CHẤM ĐIỂM",'#80ff00','#ffffff','#000000','#000000','',16,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#ffffff','#c1ff84','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var lam_lai = CreText('lam_lai',496,10,121,28,"LÀM LẠI",'#80ff00','#ffffff','#000000','#000000','',16,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#ffffff','#c1ff84','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var m_diem = CreText('m_diem',183,201,327,68,"10 điểm",'#ffc0cb','#ffffff','#ff0000','#ffffff','',36,'Comic Sans MS','','center','middle',12,'0.00','2','2',1,'#ff0000','#ffc0cb','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var toolTip = CreText('toolTip',669,166,185,40,"ĐIỂM",'#ffffe0','#ffffff','#009300','#ffffff','',20,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#009300','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
