folder_Resource ='data/dien_van_inh_enh';
var aX=["thông minh","bình rượu","máy tính","đình làng","binh lính","dính líu","cây đinh","đỉnh núi","kinh tế","mắt kính","kính trọng","hình vuông","linh tính","minh mẫn","lừa phỉnh","rình rập","học sinh","que tính","lặng thinh","thính giác","vinh dự"];
var aS=["bệnh viện","lênh khênh","dòng kênh","ễnh ương","bập bênh","lơ đễnh","ghềnh đá","chênh vênh","mênh mông","mệnh lệnh","thênh thang","vênh váo"];
function InitCur(){
SetMoveView("","obj_s",1);
SetMoveView("","obj_x",1);
...
var aVan0=["ênh","ếnh","ềnh","ểnh","ễnh","ệnh"];
var aVan1=["inh","ính","ình","ỉnh","ĩnh","ịnh"];
var aDau=["...",".´..",".`..",". ̉..",".˜..","..̣."];
function  NewGame()
{
  SetShowObject("","lam_lai",0);
...
var title = CreText('title',17,10,313,38,"1. Điền vần inh hay vần ênh:",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',20,'Arial','Normal','left','middle',0,'0.00','30','30',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var obj_s = CreText('obj_s',329,48,60,34,"ênh",'#ffffe0','#ffffff','#0000ff','#ffffff','',20,'Arial','Normal','center','middle',0,'0.00','30','30',1,'#7f7f7f','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var obj_x = CreText('obj_x',239,49,65,34,"inh",'#ffffe0','#ffffff','#0000ff','#ffffff','',20,'Arial','Normal','center','middle',0,'0.00','30','30',1,'#7f7f7f','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var cham_diem = CreText('cham_diem',251,400,141,35,"CHẤM ĐIỂM",'#80ff00','#ffffff','#000000','#000000','',16,'Arial','Bold','center','middle',3,'0.00','5','0',1,'#7f7f7f','#baff75','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var lam_lai = CreText('lam_lai',252,400,141,35,"LÀM LẠI",'#80ff00','#ffffff','#000000','#000000','',16,'Arial','Bold','center','middle',3,'0.00','5','0',1,'#7f7f7f','#baff75','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var m_diem = CreText('m_diem',189,214,297,70,"10 điểm",'rgba(128,255,0,0.89)','#ffffff','#ff0000','#ffffff','',26,'Comic Sans MS','','center','middle',12,'0.00','2','2',1,'#ffffff','rgba(128,255,0,0.89)','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var toolTip = CreText('toolTip',762,189,185,40,"10 điểm",'#ffffe0','#ffffff','#009300','#ffffff','',20,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#009300','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
