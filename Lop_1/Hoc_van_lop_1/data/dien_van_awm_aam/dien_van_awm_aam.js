...
var title = CreText('title',17,10,313,38,"1. Điền vần ăm hay vần âm:",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',20,'Arial','Normal','left','middle',0,'0.00','30','30',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var obj_s = CreText('obj_s',329,48,60,34,"âm",'#ffffe0','#ffffff','#0000ff','#ffffff','',20,'Arial','Normal','center','middle',0,'0.00','30','30',1,'#7f7f7f','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var obj_x = CreText('obj_x',239,49,65,34,"ăm",'#ffffe0','#ffffff','#0000ff','#ffffff','',20,'Arial','Normal','center','middle',0,'0.00','30','30',1,'#7f7f7f','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var cham_diem = CreText('cham_diem',250,395,141,38,"CHẤM ĐIỂM",'#80ff00','#ffffff','#000000','#000000','',16,'Arial','Bold','center','middle',3,'0.00','5','0',1,'#7f7f7f','#baff75','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var lam_lai = CreText('lam_lai',251,395,141,38,"LÀM LẠI",'#80ff00','#ffffff','#000000','#000000','',16,'Arial','Bold','center','middle',3,'0.00','5','0',1,'#7f7f7f','#baff75','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var m_diem = CreText('m_diem',188,209,297,70,"10 điểm",'rgba(128,255,0,0.89)','#ffffff','#ff0000','#ffffff','',26,'Comic Sans MS','','center','middle',12,'0.00','2','2',1,'#ffffff','rgba(128,255,0,0.89)','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var toolTip = CreText('toolTip',761,184,185,40,"ĐIỂM",'#ffffe0','#ffffff','#009300','#ffffff','',20,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#009300','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
