folder_Resource ='data/dien_van_om_oom';
var aX=["lom khom","đom đóm","làng xóm","chòm râu","dòm ngó","trông nom","gom góp","khóm tre","hóm hỉnh","nghe lóm","lồi lõm","vòm lá","quả bom","đồ dỏm","thâu tóm"];
var aS=["bánh cốm","lọ gốm","con tôm","chó đốm","chôm chôm","dày cộm","bao gồm","lốm đốm","mồm miệng","nôm na","ôm ấp","rôm rả","đau ốm"];
function InitCur(){
SetMoveView("","obj_s",1);
SetMoveView("","obj_x",1);
...
var aVan0=["ôm","ốm","ồm","ổm","ỗm","ộm"];
var aVan1=["om","óm","òm","ỏm","õm","ọm"];
var aDau=["...",".´..",".`..",". ̉..",".˜..","..̣."];
function  NewGame()
{
  SetShowObject("","lam_lai",0);
...
var title = CreText('title',17,10,313,38,"1. Điền vần om hay vần ôm:",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',20,'Arial','Normal','left','middle',0,'0.00','30','30',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var cham_diem = CreText('cham_diem',248,389,141,38,"CHẤM ĐIỂM",'#80ff00','#ffffff','#000000','#000000','',20,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#ffffff','#baff75','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var obj_s = CreText('obj_s',329,48,60,34,"ôm",'#ffffe0','#ffffff','#0000ff','#ffffff','',20,'Arial','Normal','center','middle',0,'0.00','30','30',1,'#7f7f7f','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var obj_x = CreText('obj_x',239,49,65,34,"om",'#ffffe0','#ffffff','#0000ff','#ffffff','',20,'Arial','Normal','center','middle',0,'0.00','30','30',1,'#7f7f7f','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var toolTip = CreText('toolTip',753,178,185,40,"ĐIỂM",'#ffffe0','#ffffff','#009300','#ffffff','',20,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#009300','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var lam_lai = CreText('lam_lai',249,389,141,38,"LÀM LẠI",'#80ff00','#ffffff','#000000','#000000','',20,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#ffffff','#baff75','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var m_diem = CreText('m_diem',180,203,297,70,"10 điểm",'rgba(128,255,0,0.89)','#ffffff','#ff0000','#ffffff','',26,'Comic Sans MS','','center','middle',12,'0.00','2','2',1,'#ffffff','rgba(128,255,0,0.89)','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
