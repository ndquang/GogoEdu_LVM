folder_Resource ='data/dien_van_iu_ieu';
var aX=["dịu dàng","chịu khó","lưỡi rìu","líu lo","trĩu quả","dìu dắt"," địu con","gió hiu hiu","con chàng hiu","ríu mắt","thiu ngủ","níu kéo","nhỏ xíu","bĩu môi"];
var aS=["buổi chiều","chú tiểu","diều sáo","hiểu bài","báo hiệu","vải thiều","giới thiệu","kì diệu","ít nhiều","thời khóa biểu","cơm niêu","biếu quà","kì diệu","điếu cày","điều khiển","con đà điểu","có hiếu","kiệu hoa","kiêu căng","khiêu chiến","cây liễu","miêu tả","phiêu lưu","bún riêu","siêu nhân","siêu âm","tiêu đề","thiếu nhi"];
function InitCur(){
SetMoveView("","obj_s",1);
SetMoveView("","obj_x",1);
...
var aVan0=["iêu","iếu","iều","iểu","iễu","iệu"];
var aVan1=["iu","íu","ìu","ỉu","ĩu","ịu"];
var aDau=["...",".´..",".`..",". ̉..",".˜..","..̣."];
function  NewGame()
{
  SetShowObject("","lam_lai",0);
...
var title = CreText('title',17,10,313,38,"1. Điền vần iu hay vần iêu:",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',20,'Arial','Normal','left','middle',0,'0.00','30','30',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var obj_s = CreText('obj_s',329,48,60,34,"iêu",'#ffffe0','#ffffff','#0000ff','#ffffff','',20,'Arial','Normal','center','middle',0,'0.00','30','30',1,'#7f7f7f','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var obj_x = CreText('obj_x',239,49,65,34,"iu",'#ffffe0','#ffffff','#0000ff','#ffffff','',20,'Arial','Normal','center','middle',0,'0.00','30','30',1,'#7f7f7f','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var cham_diem = CreText('cham_diem',265,398,121,28,"Chấm Điểm",'#80ff00','#ffffff','#000000','#000000','',14,'Arial','Bold','center','middle',3,'0.00','0','0',2,'#ffffff','#c1ff84','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var lam_lai = CreText('lam_lai',265,397,121,28,"Làm Lại",'#80ff00','#ffffff','#000000','#000000','',14,'Arial','Bold','center','middle',3,'0.00','0','0',2,'#ffffff','#c1ff84','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var m_diem = CreText('m_diem',178,209,327,68,"10 điểm",'#ffc0cb','#ffffff','#ff0000','#ffffff','',36,'Comic Sans MS','','center','middle',12,'0.00','2','2',1,'#ff0000','#ffc0cb','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var toolTip = CreText('toolTip',664,174,185,40,"ĐIỂM",'#ffffe0','#ffffff','#009300','#ffffff','',20,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#009300','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
