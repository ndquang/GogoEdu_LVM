folder_Resource ='data/dien_van_au_au';
var aX=["chì màu","rau cải","cây cau","lau sậy","bà cháu","rau muống","rau non","đau bụng","lau lách","lau chùi","máu đỏ","sau chót","số sáu","tàu bay","cái thau","báu vật"];
var aS=["nấu cơm","chim sâu","châu chấu","sáo sậu","cái cầu","con trâu","cầu trượt","đấu vật","xâu kim","âu yếm","chim câu","máy khâu","châu chấu","cá sấu","yêu cầu","giàn bầu","câu cá","quả dâu","chai dầu","đầu bò","con gấu","mưa ngâu","dưa hấu","nhà lầu","lâu năm","mẫu giáo","phẫu thuật","che dấu","xấu xí"];
function InitCur(){
SetMoveView("","obj_s",1);
SetMoveView("","obj_x",1);
...
var aVan0=["âu","ấu","ầu","ẩu","ẫu","ậu"];
var aVan1=["au","áu","àu","ảu","ãu","ạu"];
var aDau=["...",".´..",".`..",". ̉..",".˜..","..̣."];
function  NewGame()
{
  SetShowObject("","lam_lai",0);
...
var title = CreText('title',17,10,313,38,"1. Điền vần au hay vần âu:",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',20,'Arial','Normal','left','middle',0,'0.00','30','30',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var obj_s = CreText('obj_s',329,48,60,34,"âu",'#ffffe0','#ffffff','#0000ff','#ffffff','',20,'Arial','Normal','center','middle',0,'0.00','30','30',1,'#7f7f7f','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var obj_x = CreText('obj_x',239,49,65,34,"au",'#ffffe0','#ffffff','#0000ff','#ffffff','',20,'Arial','Normal','center','middle',0,'0.00','30','30',1,'#7f7f7f','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var cham_diem = CreText('cham_diem',253,399,121,28,"CHẤM ĐIỂM",'#80ff00','#ffffff','#000000','#000000','',14,'Arial','Bold','center','middle',3,'0.00','0','0',2,'#ffffff','#c1ff84','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var lam_lai = CreText('lam_lai',253,399,121,28,"LÀM LẠI",'#80ff00','#ffffff','#000000','#000000','',14,'Arial','Bold','center','middle',3,'0.00','0','0',2,'#ffffff','#c1ff84','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var m_diem = CreText('m_diem',166,210,327,68,"10 điểm",'#ffc0cb','#ffffff','#ff0000','#ffffff','',36,'Comic Sans MS','','center','middle',12,'0.00','2','2',1,'#ff0000','#ffc0cb','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var toolTip = CreText('toolTip',652,175,185,40,"ĐIỂM",'#ffffe0','#ffffff','#009300','#ffffff','',20,'Arial','Bold','center','middle',0,'0.00','0','0',1,'#009300','#ffffe0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
