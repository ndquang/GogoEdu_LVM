folder_Resource ='data/vuong_tron_tamgiac';
var m_curent="";
var m_color="#ff0000";
var diem = 0 ;
var ww =0;
...
hh = GetHeight("","obj1")/2;
Offset("","obj1",ww,hh );
MoveObjectTo("","obj1",-1,-1);
GetVer();
}
function  Quay()
{
  var r = Number(GetRotateObj("","obj1"));
  r = r + 90;
  RotateObj("","obj1",r%360);
  InvalidateObj("","");
}
...
function  CheckObject()
{
	...
	while(i< 8 && !b_exit)
	{
		if(RectInRect("","","k"+i))
			{
				if(ShapeType("","")==ShapeType("","k"+i) && GetRotateObj("","")== GetRotateObj("","k"+i) && GetText("","k"+i)=="")
				   {
...
Page_1.add(Page1_Backrounnd,title,obj0,obj1,obj2,obj3,obj4,obj5,obj6,obj7,obj8,obj9,Color_0,Color_5,Color_6,Color_8,Color_9,Color_10,Color_11,Color_12,Color_13,Color_14,cur_color,grMessage);
stage.add(Page_1);

 var Page_2 = new Kinetic.Layer({name: 'Page_2',callback:'Page_2()'});
var Page2_Backrounnd = CreText('Page2_Backrounnd',0,0,640,460,'','#e6e6fa','','','','',12,'Times New Roman','','left','center',0,'0.00','0',0,'0',0,'#e6e6fa','0','1','0','','0','0','0','0',0,0,'');
...
var k5 = CreText('k5',276,342,85,86,"",'#ffffff','#ffffff','rgba(0,0,0,0)','#000000','',16,'Arial','Normal','center','middle',4,'0.00','100','0',1,'#000000','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var obj1 = CreText('obj1',91,209,82,86,"",'#ff00ff','#ffffff','#000000','#ffffff','',16,'Arial','Normal','center','middle',4,'0.00','100','0',1,'#ffffff','#ff00ff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
obj1.on('mouseup touchend dragend',function(evt)/*---dragend---*/
{
m_pgObjCaller = this;
CheckObject();
...
var Text_1 = CreText('Text_1',74,278,33,29,"ↄ",'#c0c0c0','#ffffff','#000000','#ffffff','',28,'Arial','Normal','center','middle',3,'0.00','6','0',2,'#ffffff','#c0c0c0','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var lbScore = CreText('lbScore',179,163,256,129,"Bạn đã hoàn thành bài học này.",'#ffc0cb','#ffffff','#000000','#000000','',18,'Arial','Normal','center','middle',0,'0.00','0','0',2,'#ffffff','#ffc0cb','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var lbCaption = CreText('lbCaption',179,163,256,19,"gamechocon",'#ff00ff','#ffffff','#ffffff','#ffffff','',16,'Arial','Normal','center','middle',0,'0.00','0','0',1,'#ffffff','#ff00ff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var btPlay = CreText('btPlay',266,254,85,27,"Chơi Lại",'#ff00ff','#ffffff','#ffffff','#ffffff','',16,'Arial','Normal','center','middle',3,'0.00','6','0',1,'#ffffff','#ff00ff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
btPlay.on('mouseup touchend dragend',function(evt)/*---dragend---*/
{
m_pgObjCaller = this;
PrevPage();
...
Page_2.add(Page2_Backrounnd,k0,k1,k3,k2,k4,k6,k5,k7,a,c,b,obj0,obj1,title,Text_1,grMsg);
stage.add(Page_2);
InitLacVietScript();
};
