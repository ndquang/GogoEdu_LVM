folder_Resource ='data/be_hoc_toan_test';
var m_limit= 10;
var pheptinh= "cong";
var m_kq=0;
var m_doi="B";
...
SetShowObject("","dan1",0);
SetShowObject("","dan2",0);
...
function  MoveBoomToDot( m_bom){
	  ...
	  RotateObj("",m_bom,0);
	  m_boom= m_bom;
	  transitionTo("",m_bom,500,x,y,1,360,1,3,"FromDot()");
}
function  MoveBoom(){
	PlayWave("","","ID_BOOM");
	if(ds== true)
...
if(GetText("","")==m_kq)
	{
		ds= true;
		PlaySound("ID_RIGHT");
		var l= GetLeft("","cau_hoi")+GetWidth("","cau_hoi")-10;
		var t= GetTop("","cau_hoi");
		MoveObjectTo("","",l,t,100,2,6,"MoveBoom()");
	...
	for(var i=0;i<5;i++){
		...
		else transitionTo("","chon_"+i,1000,-1,-1,1,0,1,4,"MoveBoom()");
	 }
	}
}
...
function  MoveEnd(){
	  ...
	  if(ds== true)
	{
	  ...
	  if(GetText("","diem1")<10 && GetText("","diem2")<10)
	 	{
	  SetShowObject("",dan,1);
	  transitionTo("",dan,500,-1,-1,2,0,0.5,8,"TaoBaiToan()");
		}
	  else {
		var diem1 = GetText("","diem1");
		var diem2 = GetText("","diem1");
		var ts= diem1 + "   :   "+  diem2;
...
function  FromDot(){
	...
	if(m_boom== "boom1")
	 {
	  var x= GetLeft("","boom2");
	  var y= GetTop("","boom2")-64;
	  transitionTo("","boom1",500,x,y,1,720,1,4,"MoveEnd()");
	}
	else
	{
	  var x= GetLeft("","boom1");
	  var y= GetTop("","boom1")-64;
	  transitionTo("","boom2",500,x,y,1,720,1,3,"MoveEnd()");
	}
}
...
function Page_1()
{
 TaoBaiToan();
 StopSound();
 var ww= GetWidth("","dan1")/2;
 var hh= GetHeight("","dan1")/2;
 Offset("","dan1",ww,hh);
 Offset("","dan2",ww,hh);
SetShowObject("","Group_1",0);
  return;
...
var Page2_Backrounnd = CreText('Page2_Backrounnd',0,0,640,480,'','#ffffff','','','','ID_IMAGE18.PNG',12,'Times New Roman','','left','center',0,'0.00','0',0,'0',0,'#000000','2','2','0','','0','0','0','0',0,0,'');
...
var cau_hoi = CreText('cau_hoi',154,193,322,53,"99 + 92 =",'rgba(0,0,0,0)','#ffffff','#ffffff','#ffffff','',40,'Arial','Bold','center','middle',0,'0.00','0','0',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
var thuyen_do = CreText('thuyen_do',73,104,108,164,"Đội 1",'#ffffff','#ffffff','rgba(0,0,0,0)','#ffffff','ID_THUYEN_RED.PNG',16,'Arial','Normal','center','middle',0,'0.00','30','30',0,'rgba(0,0,0,0)','#ffffff','2','2','rgba(0,0,0,0)','0','0','4','0',0,0, 'rgba(0,0,0,0)',0,1.50);
...
var chon_1 = CreText('chon_1',175,379,66,53,"20",'rgba(0,0,0,0)','#ffffff','#ffffff','#ffffff','',40,'Arial','Bold','center','middle',0,'0.00','33','75',0,'rgba(0,0,0,0)','#005500','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var chon_0 = CreText('chon_0',51,378,66,53,"10",'rgba(0,0,0,0)','#ffffff','#ffffff','#ffffff','',40,'Arial','Bold','center','middle',0,'0.00','33','75',0,'rgba(0,0,0,0)','#005500','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var thuyen_xanh = CreText('thuyen_xanh',463,86,107,151,"Đội 2",'#ffffff','#ffffff','rgba(0,0,0,0)','#ffffff','ID_THUYEN_BLUE.PNG',16,'Arial','Normal','center','middle',0,'0.00','30','30',0,'rgba(0,0,0,0)','#ffffff','2','2','rgba(0,0,0,0)','0','0','4','0',0,0, 'rgba(0,0,0,0)',0,1.50);
var boom2 = CreText('boom2',500,187,37,37,'','rgba(0,0,0,0)','','','','ID_ITEM_0.PNG',0,'','','','',0,'0.00','30','30',1,'rgba(0,0,0,0)','','2','2','','0','0','4','0',0,0, '#808080');
var boom1 = CreText('boom1',103,201,41,43,'','rgba(0,0,0,0)','','','','ID_ITEM_1.PNG',0,'','','','',0,'0.00','30','30',1,'rgba(0,0,0,0)','','2','2','','0','0','4','0',0,0, '#808080');
var doi_xanh = CreText('doi_xanh',474,169,79,38,"Đội 1",'#ffffff','#ffffff','rgba(0,0,0,0)','#ffffff','ID_DOI2.PNG',16,'Arial','Normal','center','middle',0,'0.00','30','30',0,'rgba(0,0,0,0)','#ffffff','2','2','rgba(0,0,0,0)','0','0','4','0',0,0, 'rgba(0,0,0,0)',0,1.50);
var dot = CreText('dot',272,123,17,15,"",'rgba(0,0,0,0)','#ffffff','#000000','#ffffff','',16,'Arial','Normal','center','middle',0,'0.00','30','30',0,'rgba(0,0,0,0)','#ffffff','0','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
...
var Message = CreText('Message',112,25,409,409,"10   -    6",'rgba(255,104,32,1.02)','#ffffff','#00ff00','#ffffff','ID_LOST.PNG',72,'Arial','Bold','center','middle',2,'0.00','33','75',0,'rgba(0,0,0,0)','rgba(255,104,32,1.02)','2','2','#ffffff','0','0','4','1',0,0, 'rgba(0,0,0,0)',0,1.50);
Message.on('mouseup touchend dragend',function(evt)/*---dragend---*/
{
m_pgObjCaller = this;
  SetText("","diem1",0);
  SetText("","diem2",0);
  transitionTo("","Group1",1000,-100,-1000,1,360,0,"TaoBaiToan()",5);
  return;
}
 );
var Image_1 = CreText('Image_1',151,128,145,58,'','rgba(0,0,0,0)','','','','ID_DOI1.PNG',0,'','','','',0,'0.00','30','30',1,'rgba(0,0,0,0)','','2','2','','0','0','4','0',0,0, '#808080');
var Image_2 = CreText('Image_2',352,129,145,58,'','rgba(0,0,0,0)','','','','ID_DOI2.PNG',0,'','','','',0,'0.00','30','30',1,'rgba(0,0,0,0)','','2','2','','0','0','4','0',0,0, '#808080');
var doi_2 = new Kinetic.Group({name:'doi_2',x:0,y:0,width:111,height:155});
doi_2.add(thuyen_xanh,doi_xanh);
var diem2 = CreText('diem2',569,113,69,76,"0",'#ffffff','#ffffff','#ffffff','#ffffff','ID_IMAGE21.PNG',42,'Arial','Bold','center','middle',0,'0.00','30','30',0,'rgba(0,0,0,0)','#000000','2','2','rgba(0,0,0,0)','0','0','4','0',0,0, 'rgba(0,0,0,0)',0,1.50);
...
var doi_do = CreText('doi_do',83,192,86,39,"Đội 1",'#ffffff','#ffffff','rgba(0,0,0,0)','#ffffff','ID_DOI1.PNG',16,'Arial','Normal','center','middle',0,'0.00','30','30',0,'rgba(0,0,0,0)','#ffffff','2','2','rgba(0,0,0,0)','0','0','4','0',0,0, 'rgba(0,0,0,0)',0,1.50);
var doi_1 = new Kinetic.Group({name:'doi_1',x:0,y:0,width:112,height:168});
doi_1.add(thuyen_do,doi_do);
var dan2 = CreText('dan2',502,176,67,70,'','rgba(0,0,0,0)','','','','ID_IMAGE_BOOM2.PNG',0,'','','','',0,'0.00','30','30',1,'rgba(0,0,0,0)','','2','2','','0','0','4','0',0,0, '#808080');
var dan1 = CreText('dan1',121,176,79,79,'','rgba(0,0,0,0)','','','','ID_IMAGE_BOOM1.PNG',0,'','','','',0,'0.00','30','30',1,'rgba(0,0,0,0)','','2','2','','0','0','4','0',0,0, '#808080');
var start = CreText('start',231,336,178,60,"Chơi Lại",'#ff6820','#ffffff','#ffffff','#ffffff','',24,'Arial','Bold','center','middle',3,'0.00','30','30',1,'#ffffff','#a52a00','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
start.on('mouseup touchend dragend',function(evt)/*---dragend---*/
{
m_pgObjCaller = this;
GetVer();
...
var Group_1 = new Kinetic.Group({name:'Group_1',x:0,y:0,width:413,height:413});
Group_1.add(Message,Image_1,Image_2,start);
Page_1.add(Page1_Backrounnd,cau_hoi,thuyen_do,Image_3,Image_4,Image_5,Image_6,Image_7,chon_4,chon_3,chon_2,chon_1,chon_0,thuyen_xanh,boom2,boom1,doi_xanh,dot,back,doi_2,diem2,diem1,doi_do,doi_1,dan2,dan1,Group_1);
stage.add(Page_1);
InitLacVietScript();
};
