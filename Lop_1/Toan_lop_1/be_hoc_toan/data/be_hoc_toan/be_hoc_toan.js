...
if(GetText("","")==m_kq)
	{
		ds= true;
		PlaySound("ID_RIGHT");
		var l= GetLeft("","cau_hoi")+GetWidth("","cau_hoi")-50;
...
function  MoveEnd(){
	  ...
	  if(ds== true)
	{
	  ...
	  transitionTo("",dan,500,-1,-1,2,0,0.5,8,"TaoBaiToan()");
		...
		else if(pheptinh=="nhan") iPhep=4;
		var upDiem = (m_limit*10+iPhep)*10+min(diem1,diem2);
		UpdateScore(upDiem);
...
var Message = CreText('Message',153,131,363,199,"10     :     6",'#b0ffff','#ffffff','#000000','#ffffff','',48,'Arial','Bold','center','middle',3,'0.00','10','0',4,'#ffffff','#00ffff','4','1','#ffffff','0','0','4','1',0,0,'rgba(0,0,0,0)',0,1.50);
...
var Image_1 = CreText('Image_1',174,143,145,58,'','rgba(0,0,0,0)','','','','ID_DOI1.PNG',0,'','','','',0,'0.00','30','30',1,'rgba(0,0,0,0)','','2','2','','0','0','4','0',0,0, '#808080');
var Image_2 = CreText('Image_2',354,142,145,58,'','rgba(0,0,0,0)','','','','ID_DOI2.PNG',0,'','','','',0,'0.00','30','30',1,'rgba(0,0,0,0)','','2','2','','0','0','4','0',0,0, '#808080');
var start = CreText('start',263,269,151,46,"Chơi Lại",'#0080ff','#ffffff','#000000','#000000','',24,'Arial','Bold','center','middle',3,'0.00','6','0',2,'#ffffff','#00ffff','4','0','rgba(0,0,0,0)','0','0','4','0',0,0,'rgba(0,0,0,0)',0,1.50);
start.on('mouseup touchend dragend',function(evt)/*---dragend---*/
{
m_pgObjCaller = this;
GetVer();
...
var Group_1 = new Kinetic.Group({name:'Group_1',x:0,y:0,width:374,height:203});
Group_1.add(start,Image_1,Image_2,Message);
